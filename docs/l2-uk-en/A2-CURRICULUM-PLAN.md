...
**свій vs його/її/їхній — Contrastive Section (Per State Standard):**

| Sentence                    | Meaning                            | Rule                       |
| --------------------------- | ---------------------------------- | -------------------------- |
| Він любить **свою** роботу. | He loves **his own** work.         | possessor = subject → свій |
| Він любить **його** роботу. | He loves **someone else's** work.  | possessor ≠ subject → його |
| Вона читає **свою** книгу.  | She reads **her own** book.        | possessor = subject → свій |
| Вона читає **її** книгу.    | She reads **someone else's** book. | possessor ≠ subject → її   |

> **Pattern Discovery**
>
> When the possessor = subject → use **свій** (своя, своє, свої)
> When the possessor ≠ subject → use **його/її/їхній**
>
> Think of it as "own" vs "someone else's"
...
**Видові пари — Explicit Aspect Pair Vocabulary (Per State Standard §4.2.4):**

| Imperfective (недок.) | Perfective (док.) | Meaning    | Prefix Pattern   |
| --------------------- | ----------------- | ---------- | ---------------- |
| писати                | написати          | to write   | на- (completion) |
| читати                | прочитати         | to read    | про- (through)   |
| робити                | зробити           | to do/make | з- (completion)  |
| їсти                  | з'їсти            | to eat     | з- (completion)  |
| пити                  | випити            | to drink   | ви- (out)        |
| говорити              | сказати           | to say     | suppletive       |
| брати                 | взяти             | to take    | suppletive       |
| давати                | дати              | to give    | -ва- removal     |
| бачити                | побачити          | to see     | по- (completion) |
| вчити                 | вивчити           | to learn   | ви- (master)     |

> **Prefix Rule for Aspect Formation**
>
> Adding a prefix often creates the perfective:
>
> - писати → **на**писати (completion)
> - читати → **про**читати (through to end)
> - робити → **з**робити (completion)
> - бачити → **по**бачити (single instance)
>
> Some pairs are suppletive (different roots):
>
> - говорити → сказати
> - брати → взяти
...
#### Numerals with Cases (Числівники з відмінками)

**Per State Standard §4.2.2 — Numeral + Noun Agreement:**

| Number             | Case Required | Pattern      | Example                      |
| ------------------ | ------------- | ------------ | ---------------------------- |
| 1 (один/одна/одне) | Nominative Sg | singular nom | одна книга                   |
| 2, 3, 4            | Nominative Pl | plural nom   | дві книги, три студенти      |
| 5-20               | Genitive Pl   | plural gen   | п'ять книг, десять студентів |
| 21                 | Nominative Sg | like 1       | двадцять одна книга          |
| 22-24              | Nominative Pl | like 2-4     | двадцять дві книги           |
| 25-30              | Genitive Pl   | like 5-20    | двадцять п'ять книг          |

> **Pattern Rule**
>
> The last digit determines the pattern:
>
> - Ends in 1 (except 11) → Nominative Singular
> - Ends in 2, 3, 4 (except 12, 13, 14) → Nominative Plural
> - All others → Genitive Plural
...
| 35     | Root families              | All vocab       | Recognition + Expansion |
| 36     | Checkpoint: Word Formation | M31-35          | Assessment              |
...
#### Module 36: Checkpoint - Word Formation

**Review of:** Modules 31-35

**Assessment areas:**

1. Motion verb prefixes (при-, ви-, в-, за-, пере-, від-, під-, об-)
2. Action verb prefixes (на-, по-, роз-, від-, за-, пере-, до-)
3. Noun suffix formation (-ість, -ство, -ння, -ач)
4. Adjective suffix formation (-ний, -ливий, -овий, -ський)
5. Root family recognition (ход-, пис-, бач-, слух-, говор-)

**CEFR Can-Do Alignment:**

- [ ] Can recognize word families and guess meaning from roots
- [ ] Can form new words using common prefixes and suffixes
- [ ] Can understand unfamiliar words by analyzing their components

**Vocabulary (10 words):** Review selection from M31-35
...
| 48  | Checkpoint: Vocabulary | M37-47       | Assessment |
...
#### Module 48: Checkpoint - Vocabulary Expansion

**Review of:** Modules 37-47

**Assessment areas:**

1. Food & Cooking vocabulary (приготувати, печериці, спеції)
2. Health & Body vocabulary (голова, болить, симптом)
3. Home & Furniture vocabulary (меблі, килим, завіса)
4. Nature & Weather vocabulary (погода, хмара, вітер)
5. Emotions & Personality vocabulary (радісний, сумний, характер)
6. Work & Professions vocabulary (професія, посада, колега)
7. Technology & Media vocabulary (інтернет, соціальні мережі, програма)
8. Travel & Transport vocabulary (подорож, маршрут, квиток)
9. City & Infrastructure vocabulary (проспект, вулиця, зупинка)
10. Hobbies, Education, Shopping, Sports vocabulary
...
**Vocabulary (10 words):** Review selection from M37-47
...
graph TD
    %% A1 Foundation
    A1[A1 Foundation] --> A2_1

    %% Phase A2.1: Cases
    subgraph A2_1 [Phase A2.1: Cases]
        M01[M01 Dative Pro] --> M02[M02 Dative Noun]
        M02 --> M03[M03 Dative Verb]
        M02 --> M04[M04 Instr Accomp]
        M04 --> M05[M05 Instr Tool]
        M05 --> M06[M06 Instr Be/Become]
        M01 --> M07[M07 Prepositions]
        M07 --> M08[M08 Integration]
    end

    %% Phase A2.2: Aspect & Comparison
    subgraph A2_2 [Phase A2.2: Aspect/Comp]
        M11[M11 Aspect Intro] --> M12[M12 Perf Past]
        M12 --> M13[M13 Perf Future]
        M13 --> M14[M14 Aspect Pairs]
        M14 --> M18[M18 Conditional]
        M15[M15 Comparative] --> M16[M16 Superlative]
        M16 --> M17[M17 Preference]
        M17 --> M19[M19 Shopping]
    end

    %% Phase A2.3: Complex Sentences
    subgraph A2_3 [Phase A2.3: Complex]
        M21[M21 Sequence] --> M22[M22 Causal]
        M22 --> M24[M24 Opinion]
        M23[M23 Reported] --> M24
        M24 --> M25[M25 Emotion]
        M26[M26 Purpose] --> M29[M29 Doctor]
        M27[M27 Relative] --> M29
    end

    %% Phase A2.4: Word Formation
    subgraph A2_4 [Phase A2.4: Word Form]
        M31[M31 Motion Pref] --> M32[M32 Action Pref]
        M33[M33 Noun Suff] --> M34[M34 Adj Suff]
        M32 --> M35[M35 Roots I]
        M35 --> M36[M36 Roots II]
    end
