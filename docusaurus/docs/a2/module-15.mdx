...
<Cloze
  ...
  blanks={[{ index: 0, answer: `про-`, options: [`про-`, `на-`, `по-`, `ви-`] }, { index: 1, answer: `на-`, options: [`про-`, `на-`, `по-`, `ви-`] }, { index: 2, answer: `-ва-`, options: [`-ти`, `-ва-`, `-ати`, `-ити`] }, { index: 3, answer: `suppletive`, options: [`prefixed`, `suffixed`, `suppletive`] }]}
/>
