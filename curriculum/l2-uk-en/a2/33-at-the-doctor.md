...
> Match the body part to the pain.
...
1. У мене ___ голова. (Hurts sing.)
   > [!answer] болить
   > [!options] болить | болять | хворіє

2. У мене ___ ноги. (Hurts pl.)
   > [!answer] болять
   > [!options] болять | болить | хворіють

3. У нього висока ___. (Fever)
   > [!answer] температура
   > [!options] температура | кашель | нежить

4. Треба купити ліки в ___. (Pharmacy)
   > [!answer] аптеці
   > [!options] аптеці | лікарні | магазині

5. Лікар виписал ___. (Prescription)
   > [!answer] рецепт
   > [!options] рецепт | таблетку | симптом

6. Що вас ___? (Bothers)
   > [!answer] турбує
   > [!options] турбує | болить | хворіє

7. Мені потрібен ___. (Doctor)
   > [!answer] лікар
   > [!options] лікар | пацієнт | рецепт

8. У мене сильний ___. (Cough)
   > [!answer] кашель
...
## true-false: Medical Truths

1. "Аптека" is where you see a doctor.
   - [ ] True
   - [x] False
   > Pharmacy.

2. "У мене болить рука" uses Nominative for "Hand".
   - [x] True
   - [ ] False

3. You should call 103 for pizza.
   - [ ] True
   - [x] False
   > Ambulance.

4. 38.5 is a normal temperature.
   - [ ] True
   - [x] False

5. "Одужувати" involves getting better.
   - [x] True
   - [ ] False

6. "Ліки" means "Doctors".
   - [ ] True
   - [x] False
   > Medicine.
...
8. Tea with lemon is a standard Ukrainian cure.
   - [x] True
   - [ ] False

## cloze: The Appointment

> Fill in the missing words.

Я прийшов у [___:1], тому що я захворів.
...
- Алло, швидка?
- Так, що сталося?
- Мій чоловік впав. У нього болить серце.
- Де ви знаходитесь?
- Вулиця Шевченка, 10.
- Скільки йому років?
- П'ятдесят.
- Чекайте, машина виїхала.

> [!answer]
> 1. Алло, швидка?
> 2. Так, що сталося?
> 3. Мій чоловік впав. У нього болить серце.
> 4. Де ви знаходитесь?
> 5. Вулиця Шевченка, 10.
> 6. Скільки йому років?
> 7. П'ятдесят.
> 8. Чекайте, машина виїхала.

## mark-the-words: Medical Terms

У мене [температура](correct) і [кашель](correct). Я йду до [лікаря](correct). Мені треба купити [ліки](correct). Моє [здоров'я](correct) важливе. [Аптека](correct) за рогом.

---

Я люблю [спорт](incorrect). Це [мій кіт](incorrect). Сонце [світить](incorrect).

## error-correction: Fix the Complaint

1. Я **болю** голова. (Grammar)
   > [!error] Я болю
   > [!answer] У мене болить
   > [!explanation] Construction is "At me hurts head".
   > [!options] У мене болить | Я болю

2. У мене болить **ноги**. (Number)
   > [!error] болить
   > [!answer] болять
   > [!explanation] Legs are plural -> болять.
   > [!options] болять | болить

3. У мене є **кашлю**. (Case)
   > [!error] кашлю
   > [!answer] кашель
   > [!explanation] "У мене (є)" takes Nominative -> кашель.
   > [!options] кашель | кашлю

4. Мені треба **аптека**. (Goal)
   > [!error] аптека
   > [!answer] аптеку
   > [!explanation] Motion into place -> Accusative.
   > [!options] аптеку | аптека

5. Дайте **рецепта**. (Case)
   > [!error] рецепта
   > [!answer] рецепт
   > [!explanation] Give (what? Accusative inanimate) -> рецепт.
   > [!options] рецепт | рецепта

6. Лікар **лікує** пацієнт. (Case)
   > [!error] пацієнт
   > [!answer] пацієнта
