...
Всі її люблять, [___:8] одного колеги.`}
  blanks={[{ answer: `від`, options: [`від`, `для`, `про`] }, { answer: `про`, options: [`про`, `для`, `від`] }, { answer: `для`, options: [`для`, `від`, `з`] }, { answer: `з`, options: [`з`, `без`, `для`] }, { answer: `о`, options: [`о`, `після`, `для`] }, { answer: `Після`, options: [`Після`, `Через`, `Для`] }, { answer: `Через`, options: [`Через`, `Для`, `Про`] }, { answer: `крім`, options: [`крім`, `для`, `з`] }]}
/>
...
Сироп [___:6] цукру підійде?`}
  blanks={[{ answer: `від`, options: [`від`, `для`, `про`] }, { answer: `Для`, options: [`Для`, `Від`, `Без`] }, { answer: `для`, options: [`для`, `від`, `з`] }, { answer: `Для`, options: [`Для`, `Від`, `Без`] }, { answer: `від`, options: [`від`, `для`, `про`] }, { answer: `без`, options: [`без`, `з`, `для`] }]}
/>
