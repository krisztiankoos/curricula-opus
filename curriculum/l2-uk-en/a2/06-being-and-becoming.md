...
2. Як сказати "She became a teacher"?

- [x] Вона стала вчителькою.
- [ ] Вона стала вчителька.
- [ ] Вона стала вчительку.

---

3. Коли використовуємо орудний з "бути"?

- [x] У минулому та майбутньому часі
- [ ] У теперішньому часі
- [ ] Ніколи

---

4. Як сказати "I work as a programmer"?

- [x] Я працюю програмістом.
- [ ] Я працюю програміст.
- [ ] Я працюю програміста.

---

5. Яке речення правильне для теперішнього часу?
...
6. Як запитати "What do you work as"?
...
- [x] Він буде інженером.
- [ ] Він буде інженер.
- [ ] Він буде інженера.

---

8. "Стати" вимагає якого відмінка?
...
10. Яка жіноча форма "програміст"?
...
11. Яке речення правильне?

- [x] Вона працює журналісткою.
- [ ] Вона працює журналістка.
- [ ] Вона працює журналістку.

---

12. Як сказати "He wants to become a doctor"?

- [x] Він хоче стати лікарем.
- [ ] Він хоче стати лікар.
- [ ] Він хоче стати лікаря.

## true-false: Instrumental with Professions

> Decide if each statement is true or false.

- [x] In present tense, we usually don't use "бути" for professions.
  > Correct! Він лікар. (not Він є лікарем.)

- [ ] "Стати" takes the nominative case.
  > False! Стати always takes instrumental: стати лікарем.

- [x] "Працювати + Instrumental" expresses "to work as."
  > Yes! Я працюю вчителем = I work as a teacher.

- [ ] "Він є лікар" is the standard way to say "He is a doctor."
  > In standard Ukrainian, we say "Він лікар" (zero copula).

- [x] Feminine profession forms like "лікарка" are grammatically correct.
  > Yes! Ukrainian has productive feminine suffixes.

- [x] "Був/була + Instrumental" is used for past tense.
  > Correct! Він був студентом. Вона була лікаркою.

- [ ] "Ким?" is the nominative of "хто."
  > "Ким?" is the instrumental of "хто."

- [x] "Він буде інженером" means "He will be an engineer."
  > Correct! Future tense uses буде + instrumental.

- [ ] "Вона лікаром" is a complete sentence in present tense.
  > In present tense, use nominative: Вона лікарка.

- [x] "Залишатися" can also take instrumental.
  > Yes! Вона залишається директоркою.
...
8. він | мріє | стати | письменником
   > [!answer] Він мріє стати письменником
   > (He dreams of becoming a writer.)

9. вона | працювала | секретаркою | п'ять | років
   > [!answer] Вона працювала секретаркою п'ять років
   > (She worked as a secretary for five years.)

10. вони | стануть | інженерами
    > [!answer] Вони стануть інженерами
    > (They will become engineers.)

11. він | був | директором | школи
    > [!answer] Він був директором школи
    > (He was the director of the school.)

12. вона | хотіла | стати | акторкою
...
Мій друг Андрій раніше [___:1]. Він вчився в університеті п'ять років. Після університету він [___:2]. Зараз він [___:3] у великій лікарні. Він каже, що завжди мріяв [___:4].

1. був студентом | був студент | був студента
   > [!answer] був студентом

2. став лікарем | став лікар | став лікаря
   > [!answer] став лікарем

3. працює лікарем | працює лікар | працює лікаря
   > [!answer] працює лікарем

4. стати лікарем | стати лікар | стати лікаря
   > [!answer] стати лікарем

---

Моя сестра Оксана [___:1] в журналі п'ять років. Потім вона [___:2]. Тепер вона [___:3]. Вона написала три книги. Я пишаюся, що моя сестра [___:4]!

1. працювала журналісткою | працювала журналістка | працювала журналістку
   > [!answer] працювала журналісткою

2. стала письменницею | стала письменниця | стала письменницю
   > [!answer] стала письменницею

3. пише книги | пише книжки | пише романи
   > [!answer] пише книги

4. стала письменницею | стала журналісткою | працює письменницею
   > [!answer] стала письменницею

## dialogue-reorder: Job Interview

- Я був журналістом п'ять років.
- Добрий день! Сідайте, будь ласка.
- Дякую! До побачення!
- Ким ви працювали раніше?
- Добрий день!
- Ми зателефонуємо вам завтра.
- Чому хочете стати програмістом?
- Мені подобаються технології і я хочу працювати в IT.

> [!answer]
> 1. Добрий день!
> 2. Добрий день! Сідайте, будь ласка.
> 3. Ким ви працювали раніше?
> 4. Я був журналістом п'ять років.
> 5. Чому хочете стати програмістом?
> 6. Мені подобаються технології і я хочу працювати в IT.
> 7. Ми зателефонуємо вам завтра.
> 8. Дякую! До побачення!

---

- Він був студентом політехніки.
- Ким працює твій тато?
- Він працює програмістом у компанії.
- Круто! А ким він хоче стати?
- Ким він був раніше?
- Він хоче стати директором заводу!

> [!answer]
> 1. Ким працює твій тато?
> 2. Він працює програмістом у компанії.
> 3. Ким він був раніше?
> 4. Він був студентом політехніки.
> 5. Круто! А ким він хоче стати?
> 6. Він хоче стати директором заводу!

## mark-the-words: Find Instrumental Forms

Click on instrumental forms used with бути/стати/працювати.

Він раніше [був студентом](correct). Зараз він лікар. Він [працює лікарем](correct) у лікарні. Його сестра [стала вчителькою](correct).

---

Вона [була журналісткою](correct) п'ять років. Потім вона [стала письменницею](correct). Зараз вона письменниця. Вона [працює письменницею](correct).

---

Мій брат інженер. Раніше він [був студентом](correct). Він [хоче стати директором](correct). Він [працює інженером](correct) на заводі.
...
- [x] Вона хоче стати журналісткою.
- [ ] Вона хоче стати журналістка.
- [ ] Вона хоче стати журналістку.
...
- [x] Він мріє стати письменником.
- [ ] Він мріє стати письменник.
- [ ] Він мріє стати письменника.

---

She worked as a secretary.

- [x] Вона працювала секретаркою.
- [ ] Вона працювала секретарка.
- [ ] Вона працювала секретарку.

---

They will become engineers.

- [x] Вони стануть інженерами.
- [ ] Вони стануть інженери.
- [ ] Вони стануть інженерів.

---

He was the director of the school.

- [x] Він був директором школи.
- [ ] Він був директор школи.
- [ ] Він був директора школи.

---

She wanted to become an actress.

- [x] Вона хотіла стати акторкою.
- [ ] Вона хотіла стати акторка.
- [ ] Вона хотіла стати акторку.
