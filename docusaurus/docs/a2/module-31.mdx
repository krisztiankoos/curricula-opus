...
Це життя, про [___:7] я мріяв.`}
  blanks={[{ index: 0, answer: `який`, options: [`який`, `яка`] }, { index: 1, answer: `який`, options: [`який`, `якому`] }, { index: 2, answer: `у якій`, options: [`у якій`, `яка`] }, { index: 3, answer: `де`, options: [`де`, `що`] }, { index: 4, answer: `який`, options: [`який`, `якого`] }, { index: 5, answer: `які`, options: [`які`, `яких`] }, { index: 6, answer: `яке`, options: [`яке`, `яким`] }]}
/>
