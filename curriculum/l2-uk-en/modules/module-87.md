...
| готувати | **при**готувати | to prepare, cook |
| снідати | **по**снідати | to have breakfast |
| обідати | **по**обідати | to have lunch |
| вечеряти | **по**вечеряти | to have dinner |
| радити | **по**радити | to advise |
| цілувати | **по**цілувати | to kiss |
| дякувати | **по**дякувати | to thank |
...
Some verbs switch between **-увати** (imperfective) and **-ити** (perfective):

| Imperfective (-увати) | Perfective (-ити) | English |
|----------------------|-------------------|---------|
...
| запитувати | запитати | to ask |
| повідомляти | повідомити | to inform, notify |
| пояснювати | пояснити | to explain |
| обговорювати | обговорити | to discuss |
| домовлятися | домовитися | to agree, arrange |
| обіцяти | пообіцяти | to promise |

### New Aspect Pairs: Cognitive

| Imperfective | Perfective | English |
|--------------|------------|---------|
| вчити | вивчити | to learn/study |
| згадувати | згадати | to remember, recall |
...
### New Aspect Pairs: Physical Actions
...
### Fill in the Missing Pair

1. запитувати - ___ → **запитати**
2. ___ - зрозуміти → **розуміти**
3. показувати - ___ → **показати**
4. ___ - забути → **забувати**
5. відкривати - ___ → **відкрити**
6. ___ - увімкнути → **вмикати**

### Use in Context

Choose the correct aspect:

1. Я довго ___ (вирішував/вирішив) цю проблему. → **вирішував** (duration)
2. Нарешті він ___ (відповідав/відповів) на моє питання! → **відповів** (finally = result)
3. Вона щодня ___ (готувала/приготувала) вечерю. → **готувала** (every day)
4. Ми ___ (домовлялися/домовилися) зустрітися завтра. → **домовилися** (result)
5. Він часто ___ (забував/забув) свої речі. → **забував** (often)
6. Я вже ___ (запрошував/запросив) їх на вечірку. → **запросив** (already)
...
1. Він готував вечерю. → Він **приготував** вечерю.
2. Вона відповідала на листи. → Вона **відповіла** на всі листи.
3. Ми обговорювали плани. → Ми **обговорили** плани.

**Perfective → Imperfective (add duration/repetition):**
1. Він пояснив правило. → Він **пояснював** правило п'ять хвилин.
2. Вона запитала. → Вона завжди **запитувала**.
3. Я вирішив задачу. → Я **вирішував** задачу годину.
