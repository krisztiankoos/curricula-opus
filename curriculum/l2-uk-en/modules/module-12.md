---
module: 12
title: "The Accusative II"
subtitle: "Direct Objects - People"
level: A1
phase: A1.2
duration: 45
...
objectives:
  ...
  - Learn accusative for animate masculine nouns
  - Understand Accusative = Genitive rule for animates
  - Practice with people and animals
grammar:
...
In Module 11, you learned masculine inanimate nouns don't change in accusative. But for **animate** nouns (people and animals), there's a twist:

**Masculine animate accusative = Genitive form!**

- Я бачу **стіл**. (I see the table.) - no change
- Я бачу **студента**. (I see the student.) - adds -а!

> 💡 **Did You Know?**
>
> This animate/inanimate distinction exists because Slavic languages evolved to help clarify "who does what to whom." With people, word order alone wasn't clear enough, so distinct endings developed. Tables don't perform actions, but students do - so we mark them differently!

## presentation

### Animate Accusative Endings

**Masculine animate (add -а or change -а → -у):**

| Nominative | Accusative | Example |
|------------|------------|---------|
| студент | студент**а** | Я бачу студента. |
| друг | друг**а** | Я бачу друга. |
| лікар | лікар**я** | Я бачу лікаря. |
| тато | тат**а** | Я бачу тата. |
| чоловік | чоловік**а** | Я бачу чоловіка. |

**Feminine animate (same as inanimate!):**

| Nominative | Accusative | Example |
|------------|------------|---------|
| студентка | студентк**у** | Я бачу студентку. |
| подруга | подруг**у** | Я бачу подругу. |
| жінка | жінк**у** | Я бачу жінку. |

> ⚡ **Pro Tip: Feminine Is Easy**
>
> Feminine nouns use the same accusative whether animate or inanimate:
> - книга → книгу (inanimate)
> - жінка → жінку (animate)
>
> Only masculine has the animate/inanimate split!

> 📜 **History Bite: Why Accusative = Genitive?**
>
> The merger of accusative and genitive for animates happened gradually in Slavic languages around 1000-1500 AD. Originally all masculines had distinct accusative forms. The genitive "invaded" animate accusative because saying "I see Ivan" sounded too similar to "Ivan sees" - ambiguous! Adding -а removed the confusion.
...
|------------|------------|---------|
| друг | друга | friend (m) |
| подруга | подругу | friend (f) |
| студент | студента | student (m) |
| студентка | студентку | student (f) |
| вчитель | вчителя | teacher (m) |
| вчителька | вчительку | teacher (f) |
| лікар | лікаря | doctor (m) |
| лікарка | лікарку | doctor (f) |
| чоловік | чоловіка | man/husband |
| жінка | жінку | woman/wife |
| хлопець | хлопця | boy/guy |
| дівчина | дівчину | girl |

> 🎭 **Culture Corner: Чекати на + Accusative**
>
> The verb **чекати** (to wait) takes **на + accusative**:
> - Я чекаю на друга. (I'm waiting for a friend.)
> - Вона чекає на лікаря. (She's waiting for the doctor.)
>
> This is a common construction you'll use often!
...
2. подруга → подруг__ (подругу)
3. чоловік → чоловік__ (чоловіка)
4. жінка → жінк__ (жінку)
5. друг → друг__ (друга)

### Complete Sentences

1. Я бачу ___ (лікар) → лікаря
2. Вона знає ___ (студентка) → студентку
3. Ми чекаємо на ___ (друг) → друга
4. Він любить ___ (дівчина) → дівчину

> 🌍 **Real World: Talking About People**
>
...
- Я знаю ___ (name of male friend)
- Я знаю ___ (name of female friend)
- Я бачу ___ (profession)
...
| Nominative Ending | Accusative | Example |
|-------------------|------------|---------|
| Consonant | + а | студент → студента |
| -ь | + я | вчитель → вчителя |
| -й | + я | водій → водія |
| -о (тато type) | -о → -а | тато → тата |
...
>
> - **Animate** nouns = people, animals, personified beings
> - Masculine animate accusative = **genitive-like** (add -а/-я)
> - Feminine animate = **same as inanimate** (-а → -у)
> - Common pattern: студент → студента, жінка → жінку
> - Verb чекати на + accusative for "waiting for"

> 🎯 **Coming Next**
>
> In Module 13, you'll learn the **Locative case** for locations:
