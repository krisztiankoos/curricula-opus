...
<GroupSort groups={{
  "Definite (Точно)": ["обов'язково", "вирішив", "обіцяю"],
  "Planning (Планування)": ["планую", "збираюся", "маю намір"],
  "Hoping (Надія)": ["сподіваюся", "мрію", "хочу"],
  "Trying (Спроба)": ["спробую", "постараюся", "думаю"]
}} />
...
<Quiz questions={[
  {
    question: `Ми будемо вечеряти о сьомій.`,
    options: [
    ...
    question: `Вони будуть працювати завтра?`,
    options: [
    ...
    question: `Я обов'язково буду там.`,
    options: [
    ...
    question: `Вона збирається купити квартиру.`,
    options: [
    ...
    question: `Ти будеш читати цю книгу?`,
    options: [
    ...
    question: `Він буде вчитися в університеті.`,
    options: [
    ...
    question: `Я буду готувати вечерю.`,
    options: [
    ...
    question: `Ви будете дивитися фільм?`,
    options: [
...
<Quiz questions={[
  {
    question: `Наступного року ми поїдемо до моря.`,
    options: [
    ...
    question: `Пізніше я подзвоню тобі.`,
    options: [
    ...
    question: `Післязавтра вона приїде.`,
    options: [
    ...
    question: `Наступного тижня ми почнемо курс.`,
    options: [
