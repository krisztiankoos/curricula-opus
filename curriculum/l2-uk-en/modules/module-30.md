...
module: 30
title: "A1 Capstone"
subtitle: "Your Ukrainian Foundation"
level: A1
phase: A1.3
duration: 60
transliteration: full
tags: [review, assessment, capstone, final]
objectives:
  - Review all A1 content (Modules 1-29)
  - Demonstrate reading, speaking, and comprehension skills
  - Integrate all grammar and vocabulary
  - Prepare for A2 level studies
grammar:
  - Comprehensive review of all A1 grammar
  - Cases: Nominative, Accusative, Locative, Genitive
...
>
> Я живу в маленькій квартирі в центрі міста. Щодня я прокидаюся о шостій, снідаю і їду на роботу метро. Увечері я відпочиваю, читаю книги або дивлюся фільми. На вихідних я люблю гуляти в парку або зустрічатися з друзями в кав'ярні.
>
> Зараз зима, холодно, йде сніг. Але я люблю зиму! Скоро Новий рік - моє улюблене свято.
...
1. Вчора я ___ (читати - past, f) цікаву книгу. → читала
2. Він живе в ___ (Київ - locative). → Києві
3. У мене немає ___ (час - genitive). → часу
4. Завтра ми ___ (бути) вдома. → будемо
5. Це ___ (мій) сестра. → моя
...
|------|----------|---------|
| Nominative | Хто? Що? | Студент читає. |
| Accusative | Кого? Що? | Бачу студента. |
| Locative | Де? | У школі. |
| Genitive | Кого? Чого? | Немає часу. |

## Verb Tenses Mastered

| Tense | Example |
|-------|---------|
| Present | Я читаю книгу. |
| Past | Я читав/читала книгу. |
| Future | Я буду читати книгу. |

## Key Vocabulary Domains

| Domain | Word Count |
|--------|------------|
| Personal info | 30+ words |
| Numbers & time | 50+ words |
| Family | 25+ words |
| Food & drinks | 40+ words |
| City & transport | 35+ words |
| Clothes & weather | 30+ words |
| Actions & routines | 40+ words |
| **Total A1** | **250+ words** |
...
> 🎓 **Congratulations!**
>
> You have completed the **A1 Ukrainian Language Course**!
>
> You demonstrated:
> - Reading and writing Cyrillic
> - Understanding of 4 grammatical cases
> - Present, past, and future verb tenses
> - Practical communication skills
> - Cultural awareness
>
> **You are ready for A2!**
