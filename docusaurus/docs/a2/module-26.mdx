...
Тепер я працюю багато, [___:6] я щасливий.`}
  blanks={[{ index: 0, answer: `тому що`, options: [`тому що`, `хоча`] }, { index: 1, answer: `Хоча`, options: [`Хоча`, `Тому що`] }, { index: 2, answer: `зате`, options: [`зате`, `бо`] }, { index: 3, answer: `Незважаючи на те що`, options: [`Незважаючи на те що`, `Оскільки`] }, { index: 4, answer: `завдяки`, options: [`завдяки`, `через`] }, { index: 5, answer: `проте`, options: [`проте`, `оскільки`] }]}
/>
