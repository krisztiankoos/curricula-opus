...
Я пішов в [___:7], щоб купити таблетки.`}
  blanks={[{ answer: `поліклініку`, options: [`поліклініку`] }, { answer: `турбує`, options: [`турбує`] }, { answer: `горло`, options: [`горло`] }, { answer: `температуру`, options: [`температуру`] }, { answer: `грип`, options: [`грип`] }, { answer: `рецепт`, options: [`рецепт`] }, { answer: `аптеку`, options: [`аптеку`] }]}
/>
