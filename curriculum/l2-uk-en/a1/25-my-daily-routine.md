...
## group-sort: When Do We Do This?
> Sort these activities by time of day.
...
## true-false: Daily Routine Facts

Decide if each statement is true or false.

- [x] "Прокидатися" is a reflexive verb.
- [ ] "Снідати" is a reflexive verb.
  > Incorrect! it's not reflexive

- [x] "Спочатку" means "first" or "at first".
- [ ] "Нарешті" means "never".
  > Incorrect! it means "finally"

- [x] "-Ся" is added to show an action done to oneself.
- [ ] "Щодня" means "sometimes".
  > Incorrect! it means "every day"

- [x] "Зазвичай" means "usually".
- [ ] "Повертатися" means "to leave".
  > Incorrect! it means "to return"

- [x] "Засинати" means "to fall asleep".
- [ ] "Виходити" means "to enter".
  > Incorrect! it means "to go out"

- [x] "Звичка" means "habit".
- [ ] "Завжди" means "never".
  > Incorrect! it means "always"
