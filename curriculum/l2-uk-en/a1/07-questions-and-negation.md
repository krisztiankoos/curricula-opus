...
1. What does "де" mean?
   ...
   - [x] where
   - [ ] when
   > де (de) = where (location)

2. Which question word means "why"?
   - [ ] що
   - [ ] як
   - [x] чому
   - [ ] коли
...
3. How do you say "when" in Ukrainian?
   - [ ] де
   - [x] коли
   - [ ] куди
   - [ ] скільки
...
5. Which word asks "where to" (direction)?
   - [ ] де
   - [ ] звідки
   - [x] куди
   - [ ] коли
...
6. How do you say "how much/many"?
   - [ ] як
   - [ ] що
   - [x] скільки
   - [ ] коли
...
10. What is the question word for "who"?
    - [ ] що
    - [x] хто
    - [ ] де
    - [ ] чому
...
12. How do you ask "why" in Ukrainian?
    - [ ] що
    - [ ] як
    - [ ] коли
    - [x] чому
...
## match-up: Question Words to Context

| Question Word | Context |
|---------------|---------|
| що | asking about objects or actions |
| хто | asking about people |
| де | asking about location |
| куди | asking about destination |
| звідки | asking about origin |
...
1. ___ ти читаєш? (What do you read?)
   > [!answer] Що
...
3. ___ ти працюєш? (When do you work?)
   > [!answer] Коли
   > [!options] Коли | Де | Що | Як

4. ___ ти? (How are you?)
   > [!answer] Як
   > [!options] Як | Що | Хто | Де

5. ___ працює? (Who works?)
   > [!answer] Хто
   > [!options] Хто | Що | Де | Коли

6. ___ ти йдеш? (Where are you going?)
   > [!answer] Куди
   > [!options] Куди | Де | Звідки | Що

7. ___ ти вивчаєш українську? (Why do you study Ukrainian?)
   > [!answer] Чому
   > [!options] Чому | Що | Як | Коли

8. ___ ти? (Where are you from?)
   > [!answer] Звідки
   > [!options] Звідки | Де | Куди | Хто

9. ___ це коштує? (How much is this?)
   > [!answer] Скільки
   > [!options] Скільки | Що | Як | Коли

10. ___ ти знаєш? (Do you know?)
    > [!answer] Чи
    > [!options] Чи | Що | Хто | Де

11. ___ тебе звуть? (What is your name? lit. How do they call you?)
    > [!answer] Як
    > [!options] Як | Що | Хто | Де

12. ___ ти говориш? (What language do you speak?)
    > [!answer] Що
    > [!options] Що | Як | Де | Коли

## true-false: Question and Negation Rules

- [x] "Чи" at the beginning of a sentence signals a yes/no question.
  > Correct! Чи + subject + verb = yes/no question

- [ ] Ukrainian question words require "do/does" like English.
  > Incorrect! Ukrainian doesn't need auxiliary verbs for questions.

- [x] "Не" goes directly before the verb to make it negative.
  > Correct! я не читаю = I don't read

- [ ] "Ніколи" (never) doesn't need "не" because it's already negative.
  > Incorrect! Ukrainian uses double negation: "Я ніколи не..."

- [x] You can skip "чи" in casual speech and use rising intonation instead.
  > Correct! "Ти читаєш?" ↗ is common in casual conversation.

- [ ] "Де" and "куди" mean exactly the same thing.
  > Incorrect! "Де" = where (location), "куди" = where to (direction)

- [x] "Звідки" asks about origin or source.
  > Correct! Звідки ти? = Where are you from?

- [x] Ukrainian uses double negation with words like "ніколи" (never).
  > Correct! "Я ніколи не п'ю каву" = I never drink coffee

- [ ] "Що" can only mean "what", never "that".
  > Incorrect! "Що" means both "what" (question) and "that" (conjunction), depending on context.

- [x] Frequency adverbs like "завжди" (always) can come before or after the verb.
  > Correct! Both "Я завжди читаю" and "Я читаю завжди" work.

- [ ] To ask "how are you", Ukrainians always say "Як справи?"
  > Incorrect! They can also say "Як ти?" (How are you?) or "Як діла?" (How are things?)
...
1. я ___ читаю українською. (I don't read in Ukrainian.)
   > [!answer] не
...
3. Ми ___ знаємо. (We don't know.)
   > [!answer] не
   > [!options] не | ні | чи | як

4. Ти ___ розумієш? (You don't understand?)
   > [!answer] не
   > [!options] не | ні | ніколи | де

5. я ___ ___ п'ю каву. (I never drink coffee.) [Two blanks!]
   > [!answer] ніколи не
   > [!options] ніколи не | не ніколи | ні не | не ні

6. Він ___ говорить англійською. (He doesn't speak English.)
   > [!answer] не
   > [!options] не | ні | ніколи | чи

7. Вони ___ пишуть листи. (They don't write letters.)
   > [!answer] не
   > [!options] не | ні | що | як

8. я ___ хочу чаю. (I don't want tea.)
   > [!answer] не
   > [!options] не | ні | ніколи | чи

9. Це ___ правда. (That's not true.)
   > [!answer] не
   > [!options] не | ні | ніколи | що

10. Чи ти ___ знаєш? (Don't you know?)
    > [!answer] не
    > [!options] не | ні | ніколи | що

11. Ми ___ ___ їмо м'ясо. (We never eat meat.)
    > [!answer] ніколи не
    > [!options] ніколи не | не ніколи | ні не | не ні

12. Вона ___ слухає музику. (She doesn't listen to music.)
    > [!answer] не
    > [!options] не | ні | ніколи | чи

## anagram: Question Words
