...
- [x] Masculine animate nouns in accusative case end in -а or -я.
  > Correct! Animate accusative = genitive for masculine nouns.

- [ ] Feminine animate nouns have special accusative endings.
  > Incorrect! Feminine animate nouns use the same -у/-ю pattern as inanimate nouns.

- [x] "Я бачу студента" is correct.
  > Correct! Animate masculine: студент → студента.

- [ ] "Я знаю лікар" is correct.
  > Incorrect! Should be "лікаря" (animate accusative).

- [x] "Вона чекає подругу" is correct.
  > Correct! Feminine accusative: подруга → подругу.

- [ ] Inanimate masculine nouns change in accusative case.
  > Incorrect! Inanimate masculine nouns stay the same (стіл → стіл).

- [x] The animate-inanimate distinction only affects masculine nouns.
  > Correct! Feminine nouns follow the same pattern regardless of animacy.

- [x] "Він бачить водія" is correct.
  > Correct! Animate masculine: водій → водія.

- [ ] "Ми чекаємо вчитель" is correct.
  > Incorrect! Should be "вчителя" (animate accusative).

- [x] Accusative = genitive for masculine animate nouns.
  > Correct! This is the key rule for animate objects.

- [ ] "Я люблю директор" is correct.
  > Incorrect! Should be "директора" (animate accusative).

- [x] "Ти знаєш мою сусідку" is correct.
  > Correct! Feminine accusative: сусідка → сусідку.

## fill-in: Complete with Animate Accusative
> Fill in the blanks with the correct accusative form.

1. Я бачу ___ у магазині.
   > [!answer] колегу
   > [!options] колега | колегу | колеги | колезі

2. Вона знає цього ___.
   > [!answer] студента
...
7. Вона бачить нашого ___.
   > [!answer] сусіда
   > [!options] сусід | сусіда | сусіду | сусідові

8. Ми знаємо цього ___.
   > [!answer] директора
...
10. Він бачить ___ на вулиці.
    > [!answer] пасажира
    > [!options] пасажир | пасажира | пасажиру | пасажирі

11. Я люблю свого ___.
    > [!answer] друга
...
14. Ти чекаєш свою ___?
    > [!answer] сусідку
    > [!options] сусідка | сусідку | сусідки | сусідці

## fill-in: Sentences in Context
> Complete the sentences with the correct accusative form.

1. У кав'ярні я бачу ___.
   > [!answer] офіціанта
   > [!options] офіціант | офіціанта | офіціанту | офіціанті

2. Вона знає мого ___ з університету.
   > [!answer] друга
   > [!options] друг | друга | другу | другові

3. Ми чекаємо ___ біля школи.
   > [!answer] вчителя
   > [!options] вчитель | вчителя | вчителю | вчителеві

4. Ти бачиш ___ на зупинці?
   > [!answer] водія
   > [!options] водій | водія | водію | водієві
...
9. Ти чекаєш свою ___?
   > [!answer] подругу
   > [!options] подруга | подругу | подруги | подрузі

10. Він бачить ___ біля метро.
    > [!answer] пасажира
    > [!options] пасажир | пасажира | пасажиру | пасажирі

11. Я люблю нашого ___.
    > [!answer] директора
    > [!options] директор | директора | директору | директорі

12. Вона знає цього ___?
    > [!answer] гостя
    > [!options] гість | гостя | гостю | гості
