...
:::tip
🌟 **Pro Tip:** When learning a new verb, always check: does it end in -ати (Class I) or -ити (Class II)? This tells you which ending pattern to use!
:::
...
<FillIn>
  <FillInQuestion
    sentence={`1. Я ___ українською. (говорити)`}
    answer={`говорю`}
    options={[`говорю`, `говориш`, `говорить`, `говоримо`]}
  />
  <FillInQuestion
...
<Anagram>
  <AnagramQuestion
    scrambled={`1. р и о в о г и т`}
    answer={`говорити`}
    hint={``}
  />
  <AnagramQuestion
    scrambled={`т ю б и л и`}
    answer={`любити`}
    hint={``}
  />
  <AnagramQuestion
    scrambled={`т и и б а ч`}
    answer={`бачити`}
    hint={``}
  />
  <AnagramQuestion
  ...
  />
  <AnagramQuestion
    scrambled={`т и и х о д`}
    answer={`ходити`}
    hint={``}
  />
  <AnagramQuestion
    scrambled={`д и і т и с`}
    answer={`сидіти`}
    hint={``}
  />
  <AnagramQuestion
    scrambled={`т и т я о с`}
    answer={`стояти`}
    hint={``}
  />
  <AnagramQuestion
  ...
  />
  <AnagramQuestion
    scrambled={`т и ж а л е`}
    answer={`лежати`}
    hint={``}
  />
  <AnagramQuestion
    scrambled={`т и с и р о п`}
    answer={`просити`}
    hint={``}
  />
  <AnagramQuestion
...
<FillIn>
  <FillInQuestion
    sentence={`1. Ми ___ борщ і вареники. (хотіти)`}
    answer={`хочемо`}
