...
1. **Food:** Яка твоя улюблена страва?
   > [!answer] Люблю борщ.
2. **Health:** Як почуваєшся?
   > [!answer] Добре, дякую.
3. **Home:** Яка твоя квартира?
   > [!answer] Затишна і світла.
4. **Nature:** Яка погода?
   > [!answer] Сьогодні сонячно.
5. **Emotions:** Ти щасливий?
   > [!answer] Так, задоволений.
6. **Work:** Ким працюєш?
   > [!answer] Програмістом.
7. **Tech:** Які соцмережі?
   > [!answer] Телеграм і Інстаграм.
8. **Hobbies:** Чим захоплюєшся?
   > [!answer] Фотографією.
9. **Education:** Де вчився?
   > [!answer] В університеті.
10. **Shopping:** Де купуєш одяг?
   > [!answer] В торговому центрі.
11. **Sports:** Займаєшся спортом?
   > [!answer] Так, бігаю.
12. **Arts:** Яку музику слухаєш?
   > [!answer] Рок і джаз.
...
5. Які слова пов'язані з емоціями?
   - [x] щасливий
   - [x] сумний
   - [ ] погода
   - [x] хвилюватися
...
7. Які слова пов'язані з технологіями?
   - [x] ноутбук
   - [x] завантажити
   - [ ] борщ
   - [x] застосунок
...
9. Які слова пов'язані з освітою?
   - [x] університет
   - [x] іспит
   - [ ] магазин
   - [x] диплом
...
11. Які слова пов'язані зі спортом?
    - [x] тренування
    - [x] перемога
    - [ ] знижка
    - [x] медаль
...
12. Які слова описують культуру?
    - [x] концерт
    - [x] виставка
    - [ ] тренування
    - [x] традиція
...
13. Які дієслова пов'язані з їжею?
    - [x] варити
    - [x] смажити
    - [ ] тренуватися
    - [x] готувати
...
15. Які слова пов'язані з транспортом?
    - [x] автобус
    - [x] метро
    - [ ] борщ
    - [x] таксі
...
2. Приготування борщу:
   ...
   5. подати зі сметаною

3. Візит до лікаря:
   1. записатися на прийом
   2. прийти в поліклініку
   3. дочекатися черги
   4. розказати про симптоми
   5. отримати рецепт

4. Переїзд у нову квартиру:
   1. знайти квартиру
   2. підписати договір
   3. запакувати речі
   4. перевезти меблі
   5. розпакувати коробки

5. Підготовка до іспиту:
   1. скласти план вивчення
   2. прочитати матеріал
   3. зробити конспект
   4. повторити перед іспитом
   5. скласти іспит

6. Покупка одягу онлайн:
   1. відкрити сайт
   2. обрати товар
   3. додати в кошик
   4. оплатити замовлення
   5. отримати доставку

7. Типовий робочий день:
   1. приїхати на роботу
   2. перевірити пошту
   3. зробити завдання
   4. пообідати
   5. поїхати додому
...
8. Похід у спортзал:
   1. зібрати спортивну сумку
   2. приїхати в зал
   3. переодягнутися
   4. зробити тренування
   5. прийняти душ

9. Святкування дня народження:
   1. запросити гостей
   2. прибрати квартиру
   3. приготувати їжу
   4. зустріти гостей
   5. відкрити подарунки

10. Вихідний день:
    1. поспати довше
    2. поснідати
    3. зайнятися хобі
    4. зустрітися з друзями
    5. подивитися фільм

11. Планування подорожі:
    1. обрати напрямок
    2. забронювати квитки
    3. забронювати готель
    4. скласти валізу
    5. вирушити в дорогу

12. Вивчення української мови:
    1. вивчити алфавіт
    2. вивчити базові слова
    3. вивчити граматику
    4. практикувати розмову
    5. читати книги

13. Прибирання квартири:
    1. зібрати речі
    2. пропилососити
    3. витерти пил
    4. помити підлогу
...
14. Приготування до зими:
    1. купити теплий одяг
    2. перевірити опалення
    3. заготовити продукти
    4. підготувати машину
    5. заплатити за комунальні

15. Типовий вечір:
    1. повернутися додому
    2. повечеряти
    3. відпочити
    4. зайнятися хобі
    5. лягти спати

## quiz: Крос-тематичний огляд

> Оберіть найкращу відповідь.

1. Як сказати "I feel sick" українською?
   - [ ] Мені смачно.
   - [x] Мені погано.
   - [ ] Мені холодно.
   - [ ] Мені весело.
...
2. Де купують ліки?
   ...
   - [ ] на ринку
   - [ ] у кіоску
   > Ліки купують в аптеці.

3. Що означає "затишний"?
   - [ ] великий
   - [x] комфортний, приємний
   - [ ] брудний
   - [ ] новий
   > Затишний = cozy, comfortable.

4. Як запитати про погоду?
   - [ ] Скільки це коштує?
   - [x] Яка погода?
   - [ ] Як справи?
   - [ ] Де ви живете?
...
5. Що означає "засмучений"?
   - [ ] щасливий
   - [x] сумний
   - [ ] злий
   - [ ] здивований
   > Засмучений = upset, sad.

6. Як сказати "job interview"?
   - [ ] робоче місце
   - [x] співбесіда
   - [ ] зарплата
   - [ ] відпустка
...
7. Що таке "застосунок"?
   - [ ] телефон
   - [x] програма на телефоні
   - [ ] комп'ютер
   - [ ] інтернет
   > Застосунок = app (application).

8. Як сказати "my hobby"?
   - [ ] моя робота
   - [x] моє хобі
   - [ ] мій дім
   - [ ] моя родина
...
9. Що означає "стипендія"?
   - [ ] робота
   - [x] гроші для студентів
   - [ ] іспит
   - [ ] оцінка
   > Стипендія = scholarship.

10. Як попросити знижку?
    - [ ] Дайте мені це!
    - [x] Є знижка?
    - [ ] Скільки це?
    - [ ] Що це?
...
11. Що означає "розминка"?
    - [ ] кінець тренування
    - [x] початок тренування
    - [ ] перерва
    - [ ] біг
    > Розминка = warm-up, початок.

12. Що таке "вишиванка"?
    - [ ] страва
    - [x] традиційна сорочка
    - [ ] танець
    - [ ] пісня
    > Вишиванка = embroidered shirt.

13. Як сказати "I'm cooking dinner"?
    - [ ] Я їм вечерю.
    - [x] Я готую вечерю.
    - [ ] Я купую вечерю.
    - [ ] Я хочу вечерю.
...
14. Що означає "переїзд"?
    - [ ] поїздка
    - [x] зміна місця проживання
    - [ ] подорож
    - [ ] прогулянка
    > Переїзд = moving (to new place).

15. Як сказати "I'm learning Ukrainian"?
...
## match-up: Тема і слово

> З'єднайте тему зі словом.
