...
Це був час, [___:7] я був щасливий.`}
  blanks={[{ index: 0, answer: `Коли`, options: [`Коли`, `Де`] }, { index: 1, answer: `тим часом як`, options: [`тим часом як`, `коли`] }, { index: 2, answer: `Після того як`, options: [`Після того як`, `Перед тим як`] }, { index: 3, answer: `перед тим як`, options: [`перед тим як`, `поки (Logic: wash hands BEFORE reading)`] }, { index: 4, answer: `Кожного разу коли`, options: [`Кожного разу коли`, `Поки`] }, { index: 5, answer: `поки`, options: [`поки`, `коли (Logic: Until the sun set)`] }, { index: 6, answer: `коли`, options: [`коли`, `де`] }]}
/>
