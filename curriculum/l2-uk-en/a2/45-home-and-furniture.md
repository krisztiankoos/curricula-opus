...
1. Я сплю у [___]. (bedroom)
   > [!answer] спальні
   > [!options] спальні | вітальні | кухні | ванній

2. Ми їмо на [___]. (kitchen)
   > [!answer] кухні
   > [!options] спальні | вітальні | кухні | ванній
...
4. Книги на [___]. (shelf)
   > [!answer] полиці
   > [!options] полиці | шафі | комоді | столі

5. Одяг у [___]. (wardrobe)
   > [!answer] шафі
   > [!options] полиці | шафі | комоді | столі

6. Тато працює в [___]. (office)
   > [!answer] кабінеті
...
Ольга переїхала в нову [___:1]. (apartment)
