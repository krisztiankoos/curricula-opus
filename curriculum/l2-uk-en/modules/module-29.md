...
module: 29
title: "Family"
subtitle: "Parents, Siblings & Beyond"
level: A1
phase: A1.3
duration: 50
transliteration: full
tags: [vocabulary, family, relationships]
objectives:
  - Learn family vocabulary
  - Describe family members
  - Talk about relationships
  - Use possessives with family
grammar:
  - Family nouns (irregular plurals)
  - У мене є + family members
  - Possessives with family terms
---
...
### Your Ukrainian Family Tree

Family is central to Ukrainian culture. Learning family terms helps you talk about yourself and understand Ukrainian society!

- **У мене велика родина.** - I have a big family.
- **Моя мама лікарка.** - My mom is a doctor.
- **Мого брата звати Андрій.** - My brother's name is Andriy.

> 💡 **Did You Know?**
>
> Ukrainian has more specific family terms than English! Where English uses "uncle," Ukrainian distinguishes:
> - **дядько** - father's or mother's brother
> - **вуйко** - mother's brother (Western Ukraine)
> - **стрийко** - father's brother (Western Ukraine)
>
> Family relationships are precisely named!
...
|-----------|-----------------|---------|--------|
| родина | rodyna | family | f |
| мама | mama | mom | f |
| тато | tato | dad | m |
| батько | batko | father | m |
| мати | maty | mother | f |
| батьки | batky | parents | pl |
| брат | brat | brother | m |
| сестра | sestra | sister | f |
| син | syn | son | m |
| дочка | dochka | daughter | f |
| дитина | dytyna | child | f |
| діти | dity | children | pl |

> ⚡ **Pro Tip: Informal vs Formal**
>
> Ukrainian has casual and formal parent words:
> - **Мама/тато** - mom/dad (informal, everyday)
> - **Мати/батько** - mother/father (formal, documents)
>
> Most people say "мама" and "тато" in conversation!
...
| небіж | nebizh | nephew |
| небога | neboha | niece |
| двоюрідний брат | dvoyuridnyi brat | cousin (m) |
| двоюрідна сестра | dvoyuridna sestra | cousin (f) |

> 📜 **History Bite: Дідусь і Бабуся**
>
> "Дідусь" and "бабуся" are affectionate diminutives. The formal terms are "дід" and "баба." In Ukrainian tradition, grandparents play a central role - many children are raised partly by бабуся while parents work. "Бабусині казки" (grandma's fairy tales) are cherished memories!
...
| наречений | narechenyi | fiancé |
| наречена | narechena | fiancée |

> 🎭 **Culture Corner: Ukrainian Wedding**
>
> Traditional Ukrainian weddings (весілля) can last 2-3 days! Key elements include:
> - **Сватання** - matchmaking/proposal ritual
> - **Вишиті рушники** - embroidered towels as symbols
> - **Коровай** - decorated wedding bread
> - **Викуп нареченої** - "buying" the bride (fun negotiations)
>
> Marriage is a major family celebration involving everyone!

### Talking About Family

**Having family members:**
- У мене є брат. (I have a brother.)
- У неї два сини. (She has two sons.)
- У нього немає сестри. (He doesn't have a sister.)

**Describing family:**
- Мій батько - інженер. (My father is an engineer.)
- Моя сестра студентка. (My sister is a student.)
- Моєму брату 25 років. (My brother is 25 years old.)

**Asking about family:**
- У тебе є брати чи сестри? (Do you have brothers or sisters?)
- Чи ти одружений/одружена? (Are you married?)
- Скільки у вас дітей? (How many children do you have?)

> 🔗 **Language Link: Irregular Plurals**
>
> Some family words have irregular plurals:
> - дитина → **діти** (children) - totally different!
> - брат → **брати** (brothers)
> - сестра → **сестри** (sisters)
> - дочка → **дочки** (daughters)
>
> "Діти" is especially important - memorize it!
...
| одружений | married (m) |
| одружена | married (f) |
| неодружений | unmarried (m) |
| неодружена | unmarried (f) |
| розлучений | divorced (m) |
| розлучена | divorced (f) |
| вдівець | widower |
| вдова | widow |

> 🌍 **Real World: Family Conversations**
>
> - **Розкажи про свою родину.** - Tell me about your family.
> - **Скільки вас у родині?** - How many are in your family?
> - **Ви схожі!** - You look alike!
> - **Він весь у батька.** - He takes after his father.
> - **Вона - копія мами.** - She's a copy of her mom.
...
1. У тебе велика родина? (Do you have a big family?)
2. У тебе є брати або сестри? (Do you have siblings?)
3. Де живуть твої батьки? (Where do your parents live?)
4. Як звати твою маму? (What's your mom's name?)
...
- У мене... (big/small family)
- Мої батьки... (where they live, what they do)
- У мене є... (siblings)
- Мого брата/сестру звати... (names)
...
| Structure | Example |
|-----------|---------|
| У мене є... | У мене є брат. |
| У мене немає... | У мене немає сестри. |
| Мій/моя/мої + noun | Моя мама вчителька. |
...
>
> - Immediate family: мама, тато, брат, сестра
> - Extended family: дідусь, бабуся, дядько, тітка
> - Marriage terms: чоловік, дружина, одружений
> - Irregular: дитина → діти
> - Possessives with family: мій тато, моя сестра
> - Questions: У тебе є...?

> 🎯 **Coming Next**
>
> Module 30 is your **A1 Capstone** - final review of everything you've learned! You'll prove you're ready for A2.
