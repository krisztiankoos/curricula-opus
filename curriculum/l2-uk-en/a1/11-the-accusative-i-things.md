...
1. What is the accusative form of "книга"?
   - [ ] книга
   - [x] книгу
   - [ ] книги
   - [ ] книзі
...
2. What is the accusative form of "паспорт"?
   - [x] паспорт
   - [ ] паспорта
   - [ ] паспорту
   - [ ] паспортом
...
3. Which verb requires accusative case?
   - [x] бачити (to see)
   - [ ] бути (to be)
   - [ ] працювати (to work)
   - [ ] спати (to sleep)
   > бачити needs an object: Я бачу книгу

4. What is the accusative form of "вікно"?
   - [ ] вікна
   - [ ] вікні
   - [x] вікно
   - [ ] вікном
...
5. Complete: "Я читаю ___" (newspaper)
   - [ ] газета
   - [x] газету
   - [ ] газети
   - [ ] газеті
...
6. Complete: "Він бере ___" (suitcase)
   - [ ] валіза
   - [x] валізу
   - [ ] валізи
   - [ ] валізі
...
7. What is the accusative form of "море"?
   - [ ] моря
   - [ ] морю
   - [x] море
   - [ ] морі
   > Neuter -е stays the same

8. Complete: "Вона дає ___" (gift)
   - [x] подарунок
   - [ ] подарунку
   - [ ] подарунка
   - [ ] подарунком
...
9. What is the accusative form of "сумка"?
   - [ ] сумка
   - [x] сумку
   - [ ] сумки
   - [ ] сумці
...
10. Complete: "Ти маєш ___?" (ticket)
    - [x] квиток
    - [ ] квитка
    - [ ] квитку
    - [ ] квитком
...
11. What is the accusative form of "коробка"?
    - [ ] коробка
    - [x] коробку
    - [ ] коробки
    - [ ] коробці
...
12. Complete: "Я відкриваю ___" (window)
    - [ ] вікна
    - [x] вікно
    - [ ] вікні
    - [ ] вікном
...
- [ ] Masculine inanimate nouns change in accusative.
  > Incorrect! They stay the same: паспорт → паспорт

- [x] The verb "бачити" takes accusative case.
  > Correct! Я бачу книгу (I see a book)

- [ ] Neuter nouns change their endings in accusative.
  > Incorrect! They stay the same: вікно → вікно

- [x] Accusative answers the question "Що?" (What?)
  > Correct! It marks the direct object

- [ ] The accusative form of "газета" is "газети".
  > Incorrect! газета → газету

- [x] The verb "мати" (to have) requires accusative.
  > Correct! Я маю книгу

- [ ] Masculine nouns ending in consonants add -а in accusative.
  > Incorrect! Inanimate masculines don't change

- [x] Feminine -я nouns change to -ю in accusative.
  > Correct! земля → землю

- [ ] The accusative of "вікно" is "вікна".
  > Incorrect! Neuter stays same: вікно

- [x] "Брати" (to take) uses accusative for the object.
  > Correct! Він бере сумку
