...
Взимку падає білий [___:6]. (snow)`}
  ...
  blanks={[{ answer: `природу`, options: [`природу`, `море`, `дачу`] }, { answer: `сонячна`, options: [`сонячна`, `хмарна`, `дощова`] }, { answer: `чисте`, options: [`чисте`, `брудне`, `мале`] }, { answer: `море`, options: [`море`, `гори`, `ліс`] }, { answer: `золота`, options: [`золота`, `зелена`, `біла`] }, { answer: `сніг`, options: [`сніг`, `дощ`, `листя`] }]}
