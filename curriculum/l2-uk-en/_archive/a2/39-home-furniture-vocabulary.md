...
3. Які слова описують житло позитивно?
   - [x] просторий
   - [x] затишний
   - [ ] темний
   - [x] світлий
...
7. Які слова пов'язані з кухнею?
   - [x] холодильник
   - [x] плита
   - [ ] ліжко
   - [x] посуд
...
9. Які слова для зберігання речей?
   - [x] шафа
   - [x] комод
   - [ ] стіл
   - [x] шухляда
...
15. Які речі потрібні для переїзду?
    - [x] коробки
    - [x] машина
    - [ ] посуд
    - [x] ключі
...
1. Як переїхати до нової квартири?
   1. знайти оголошення
   2. подивитися квартиру
   3. підписати договір
   4. зібрати речі
   5. переїхати

2. Як застелити ліжко?
   1. зняти стару білизну
   2. покласти чисте простирадло
   3. надіти наволочку на подушку
   4. покласти ковдру
   5. накрити покривалом

3. Як помити посуд?
   1. зібрати брудний посуд
   2. налити воду
   3. додати миючий засіб
   4. помити кожну тарілку
   5. поставити сушитися

4. Як прибрати квартиру?
   1. зібрати речі
   2. пропилососити підлогу
   3. витерти пил
   4. помити підлогу
   5. провітрити кімнати

5. Ранок вдома
   1. прокинутися
   2. застелити ліжко
   3. піти до ванної
   4. приготувати сніданок
   5. вийти з дому

6. Як орендувати квартиру?
   1. визначити бюджет
   2. шукати оголошення
   3. зателефонувати власнику
   4. переглянути квартиру
   5. підписати договір

7. Як обладнати спальню?
   1. купити ліжко
   2. вибрати матрац
   3. поставити тумбочку
   4. повісити штори
   5. додати декор
...
8. Як зробити ремонт?
   1. скласти план
   2. купити матеріали
   3. прибрати старі меблі
   4. пофарбувати стіни
   5. розставити меблі

9. Як запросити гостей?
   1. прибрати квартиру
   2. приготувати їжу
   3. накрити стіл
   4. зустріти гостей
...
10. Як увімкнути пральну машину?
    1. покласти білизну
    2. додати порошок
    3. вибрати програму
    4. натиснути пуск
...
11. Вечір вдома
    1. повернутися з роботи
    2. перевдягнутися
    3. приготувати вечерю
    4. подивитися телевізор
    5. лягти спати

12. Як облаштувати кухню?
    1. поставити холодильник
    2. під'єднати плиту
    3. розставити посуд
    4. повісити полиці
    5. додати декор

13. Як прасувати одяг?
    1. увімкнути праску
    2. почекати нагрівання
    3. розкласти одяг
    4. попрасувати
    5. повісити в шафу

14. Як продати квартиру?
    1. оцінити вартість
    2. дати оголошення
    3. показати покупцям
    4. домовитися про ціну
    5. підписати договір

15. Як облаштувати балкон?
    1. прибрати балкон
    2. поставити меблі
    3. додати рослини
    4. повісити гірлянди
...
## quiz: Приміщення та предмети

> Оберіть правильну відповідь.

1. Де зазвичай стоїть холодильник?
   - [x] на кухні
   - [ ] у спальні
   - [ ] у ванній
   - [ ] на балконі
   > Холодильник стоїть на кухні.

2. Що робить пральна машина?
   - [ ] готує їжу
   - [x] пере одяг
   - [ ] охолоджує продукти
   - [ ] нагріває воду
   > Пральна машина пере одяг.

3. Де зазвичай є дзеркало?
   - [ ] тільки у вітальні
   - [x] у ванній і спальні
   - [ ] на кухні
   - [ ] на балконі
   > Дзеркало є у ванній і спальні.

4. Що означає "затишний"?
   - [ ] great
   - [x] cozy
   - [ ] dirty
   - [ ] modern
...
5. Для чого потрібен комод?
   - [x] для зберігання одягу
   - [ ] для сидіння
   - [ ] для сну
   - [ ] для приготування їжі
   > Комод — для зберігання одягу.
...
6. Що таке "під'їзд"?
   ...
   - [ ] apartment
   - [ ] floor
   > "під'їзд" = building entrance

7. Де стоїть тумбочка?
   - [x] біля ліжка
   - [ ] на кухні
   - [ ] у ванній
   - [ ] на балконі
   > Тумбочка стоїть біля ліжка.

8. Що означає "орендна плата"?
   - [x] rent payment
   - [ ] deposit
   - [ ] utility bill
   - [ ] mortgage
   > "орендна плата" = rent payment

9. Яка меблі для сидіння м'яка?
   - [x] диван і крісло
   - [ ] стіл і стілець
   - [ ] шафа і комод
   - [ ] ліжко і тумбочка
   > Диван і крісло — м'які меблі для сидіння.

10. Що означає "провітрювати"?
    - [ ] to clean
    - [x] to air out
    - [ ] to vacuum
    - [ ] to repair
    > "провітрювати" = to air out

11. Де зберігають посуд?
    - [ ] у ванній
    - [x] на кухні
    - [ ] у спальні
    - [ ] на балконі
    > Посуд зберігають на кухні.

12. Що таке "багатоповерховий будинок"?
...
13. Для чого потрібен килим?
    - [x] для підлоги
    - [ ] для стелі
    - [ ] для вікна
    - [ ] для дверей
    > Килим кладуть на підлогу.

14. Що означає "обладнаний"?
    - [ ] empty
    - [x] furnished
    - [ ] old
    - [ ] broken
...
15. Де вішають штори?
    ...
    - [ ] на стінах
    - [ ] на підлозі
    > Штори вішають на вікнах.

## match-up: Предмет та кімната

> З'єднайте предмет з кімнатою.
...
| холодильник | кухня |
| душ | ванна кімната |
| письмовий стіл | кабінет |
| плита | кухня |
| умивальник | ванна кімната |
| шафа | спальня |
| крісло | вітальня |
| пральна машина | ванна кімната |
| тумбочка | спальня |
| мийка | кухня |
| комп'ютер | кабінет |
| телевізор | вітальня |
