...
tags:
  ...
  - permission
grammar:
  - Modal verbs (могти, вміти, мусити)
...
> [!conversation] Discussing Abilities
>
> — Ти **вмієш** плавати?
...
Match the Ukrainian modal with its English meaning.

- могти :: can, be able to
- вміти :: know how to
- повинен :: must (personal)
- треба :: need to (impersonal)
- можна :: may, allowed
- не можна :: not allowed
- заборонено :: forbidden
- дозволено :: permitted
- слід :: should, ought to
- варто :: worth, advisable
- готовий :: ready
- здатний :: capable

---

## group-sort: Modal Categories
...
## fill-in: могти Conjugation
> Complete with the correct form of могти.

1. Я ___ говорити українською.
   > [!answer] можу
...
7. ___ подивитися цей фільм.
   > [!answer] Варто
   > [!options] Варто | Треба | Не можна | Заборонено

8. ___ відпочити після роботи.
   > [!answer] Слід
...
8. Слід відпочити.
   ...
   - [ ] One must rest.
   - [ ] One can rest.
   - [ ] One is forbidden to rest.

---

## unjumble: Modal Sentences
...
## true-false: Modal Understanding

Decide if each statement is true or false.

- [x] "Вміти" means "to know how to" (learned skill).
- [ ] "Могти" means "must".
  > Incorrect! it means "can"

- [x] "Можна" is used to ask permission.
- [ ] "Заборонено" means "allowed".
  > Incorrect! it means "forbidden"

- [x] "Треба" is an impersonal word for necessity.
- [ ] "Повинен" changes gender: повинен/повинна.
- [x] "Варто" means "worth" or "advisable".
- [ ] "Мусити" means "to want".
  > Incorrect! it means "must"

- [x] "Готовий" means "ready".
- [ ] "Слід" means "forbidden".
  > Incorrect! it means "should"

- [x] "Здатний" means "capable".
- [ ] "Не можна" means "you can".
  > Incorrect! it means "not allowed"
