...
**Why this matters:** Whether you're sending a package to family, exchanging currency, or opening an account, knowing how to communicate at the post office and bank is essential for daily life in Ukraine.

**What you'll learn:**
- Post office vocabulary: sending letters, packages, stamps
- Banking vocabulary: accounts, cards, transfers
- Polite request formulas
- Case usage in service contexts
...
Read these dialogues aloud and identify the cases used:
...
У цьому модулі ви вивчили лексику для пошти та банку:
...
**Key Phrases:**
- Я хочу відправити/отримати...
- Мені потрібно обміняти/зняти...
- Скільки це коштує?
- Який сьогодні курс?
