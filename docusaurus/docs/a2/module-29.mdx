...
Я [___:6], що зустріну друга. Це [___:7], що ми друзі.`}
  blanks={[{ index: 0, answer: `сумно`, options: [`сумно`, `весело`] }, { index: 1, answer: `боявся`, options: [`боявся`, `радів`] }, { index: 2, answer: `почуваюся`, options: [`почуваюся`, `відчуваю`] }, { index: 3, answer: `весело`, options: [`весело`, `сумно`] }, { index: 4, answer: `обожнюю`, options: [`обожнюю`, `ненавиджу`] }, { index: 5, answer: `сподіваюся`, options: [`сподіваюся`, `боюся`] }, { index: 6, answer: `добре`, options: [`добре`, `погано`] }]}
/>
