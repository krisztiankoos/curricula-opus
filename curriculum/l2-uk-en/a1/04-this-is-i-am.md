...
tags: ["grammar", "pronouns", "identity", "zero-copula"]
grammar: ["personal-pronouns", "zero-copula", "це-demonstrative"]
objectives:
  ...
  - "Learner can distinguish masculine and feminine nationality forms"
vocabulary_count: 32
---
...
1. ___ студент. (I am a student.)
   - [x] Я
   - [ ] Ти
   - [ ] Він
   - [ ] Вона

2. ___ лікар. (He is a doctor.)
   - [ ] Я
   - [ ] Ти
   - [x] Він
   - [ ] Вона

3. ___ студенти. (They are students.)
   - [ ] Я
   - [ ] Ти
   - [ ] Він
   - [x] Вони

4. ___ українка. (She is Ukrainian.)
   - [ ] Я
   - [ ] Ти
   - [ ] Він
   - [x] Вона

5. Which pronoun is both plural AND formal singular?
   - [ ] Я
   - [ ] Ти
   - [ ] Ми
   - [x] Ви

6. Which pronoun would you use with your friend?
   - [ ] Я
   - [x] Ти
   - [ ] Він
   - [ ] Ви

7. Which pronoun would you use with your professor?
   - [ ] Я
   - [ ] Ти
   - [ ] Він
   - [x] Ви

8. ___ студенти. (We are students.)
   - [ ] Я
   - [ ] Ти
   - [x] Ми
   - [ ] Вони

9. What does "воно" mean?
   - [ ] he
   - [ ] she
   - [x] it
   - [ ] they
...
10. Which pronoun is always lowercase (unless starting a sentence)?
    - [x] я
    - [ ] ти
    - [ ] він
    - [ ] вони
    > я is lowercase like English "I" became uppercase—Ukrainian kept it lowercase!

11. What's the plural of "він"?
    - [ ] ви
    - [ ] ми
    - [x] вони
    - [ ] воно
    > Вони = they (all genders)

12. You meet a stranger. Which do you use?
    - [ ] ти
    - [x] Ви
    - [ ] він
    - [ ] вони
    > Always start with Ви for strangers (formal)

## match-up: Pronouns and Meanings
...
2. ___ українка. (She is Ukrainian)
   > [!answer] Вона
   > [!options] Я | Ти | Він | Вона

3. ___ професор? (Are you a professor?)
   > [!answer] Ти
   > [!options] Я | Ти | Він | Ми

4. ___ лікар. (He is a doctor)
   > [!answer] Він
   > [!options] Я | Він | Вона | Воно

5. ___ студенти. (We are students)
   > [!answer] Ми
   > [!options] Я | Ти | Ми | Ви

6. ___ українці. (They are Ukrainians)
   > [!answer] Вони
   > [!options] Він | Вона | Ми | Вони

7. ___ професорка? (Are you a professor? - formal)
   > [!answer] Ви
   > [!options] Ти | Він | Ви | Вони

8. ___ друг. (He is a friend)
   > [!answer] Він
   > [!options] Я | Він | Ми | Вони

9. ___ людина. (She is a person)
   > [!answer] Вона
   > [!options] Він | Вона | Воно | Вони

10. ___ подруга? (Is she a friend?)
    > [!answer] Вона
    > [!options] Я | Він | Вона | Ви

11. ___ англієць. (I am English)
    > [!answer] Я
    > [!options] Я | Ти | Він | Ми

12. ___ канадці. (You all are Canadians)
    > [!answer] Ви
...
- [x] Ukrainian does not use "am/is/are" in present tense statements.
  > Correct! This is called "zero copula."

- [ ] The pronoun "я" is always capitalized like English "I."
  > Incorrect! "я" is lowercase unless it starts a sentence.

- [x] "Ви" can mean both "you all" and formal "you" (singular).
  > Correct! Context tells you which.

- [ ] "Це" changes form for plural.
  > Incorrect! "Це" works for both singular and plural.

- [x] Feminine professions typically add "-ка" to the masculine form.
  > Correct! студент → студентка, лікар → лікарка

- [ ] You should always use "ти" with strangers to be friendly.
  > Incorrect! Use "Ви" with strangers—it's respectful.

- [x] "Людина" is grammatically feminine but refers to any person.
  > Correct! It's a feminine noun but gender-neutral in meaning.

- [ ] Ukrainian has more pronouns than English.
  > Incorrect! Same number, but "ви" has dual function.

- [x] "Він" is used for masculine nouns, not just male people.
  > Correct! All masculine nouns use "він."

- [ ] In Ukrainian, you must say "Я є студент" to mean "I am a student."
  > Incorrect! Just say "Я студент." The "є" is dropped.

- [x] "Друг" and "подруга" can mean both friend and romantic partner.
  > Correct! Context is key.

- [x] Saying "Я українець/українка" is an important identity statement in Ukrainian culture.
  > Correct! It's a proud affirmation of national identity.
...
1. What is the feminine form of "українець"?
   - [ ] українець
   - [x] українка
   - [ ] україна
   - [ ] україниця
   > українець → українка (add -ка)

2. What is the feminine form of "американець"?
   - [ ] америка
   - [ ] американиця
   - [x] американка
   - [ ] американець
   > американець → американка (add -ка)

3. What is the feminine form of "англієць"?
   - [x] англійка
   - [ ] англійця
   - [ ] англія
   - [ ] англієць
   > англієць → англійка (add -ка)

4. What is the feminine form of "канадець"?
   - [ ] канада
   - [x] канадка
   - [ ] канадиця
   - [ ] канадець
   > канадець → канадка (add -ка)

5. What is the feminine form of "студент"?
   - [ ] студент
   - [ ] студентиня
   - [x] студентка
   - [ ] студента
   > студент → студентка (add -ка)

6. What is the feminine form of "професор"?
   - [ ] професор
   - [x] професорка
   - [ ] професориха
   - [ ] професора
   > професор → професорка (add -ка)

7. What is the feminine form of "лікар"?
   - [ ] лікар
   - [x] лікарка
   - [ ] лікариня
   - [ ] лікаря
   > лікар → лікарка (add -ка)

8. What is the feminine form of "друг"?
   - [ ] дружка
   - [x] подруга
   - [ ] друга
   - [ ] друг
   > друг → подруга (special form)

9. Which ending do most feminine nationality forms add?
   - [ ] -а
   - [x] -ка
   - [ ] -иня
   - [ ] -иця
   > Most add -ка to the masculine stem

10. "Він українець, вона ___."
    - [ ] українець
    - [x] українка
    - [ ] український
    - [ ] україна
    > вона українка (feminine)

11. "Я студент" is said by a ___.
    - [x] male
    - [ ] female
    - [ ] neuter
    - [ ] plural
    > студент = masculine form

12. "Я студентка" is said by a ___.
    - [ ] male
    - [x] female
    - [ ] neuter
    - [ ] plural
    > студентка = feminine form

## anagram: Build the Words
