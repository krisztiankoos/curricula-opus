...
1. Які слова про шкільні предмети?
   - [x] математика
   - [x] фізика
   - [ ] декан
   - [x] історія
...
10. Які слова про навчальні матеріали?
    - [x] підручник
    - [x] зошит
    - [ ] оцінка
    - [x] словник
...
11. Які види діяльності студента?
    - [x] вчитися
    - [x] здавати іспити
    - [ ] викладати
    - [x] писати реферат
...
2. День школяра
   1. прокинутися
   2. зібратися до школи
   3. бути на уроках
   4. повернутися додому
   5. робити домашнє завдання

3. Від найгіршої до найкращої оцінки
   1. один
   2. три
   3. шість
   4. дев'ять
...
6. Вступ до університету
   1. закінчити школу
   2. вибрати спеціальність
   3. подати документи
   4. скласти вступні іспити
   5. стати студентом

7. Один урок
   1. дзвінок на урок
   2. привітання з учителем
...
8. Навчальний рік
   ...
   3. зимові канікули
   4. весняні канікули
   5. червень - закінчення

9. Отримання диплому
   1. закінчити навчання
   2. написати дипломну роботу
   3. захистити роботу
   4. скласти державні іспити
   5. отримати диплом

10. Читання книги для школи
    1. взяти книгу
    2. прочитати розділ
    3. виписати головні ідеї
    4. підготувати відповіді
    5. обговорити на уроці

11. Підготовка презентації
    1. обрати тему
    2. зібрати інформацію
    3. зробити слайди
    4. практикувати виступ
    5. презентувати класу

12. Робота над помилками
    1. отримати роботу
    2. переглянути помилки
    3. зрозуміти правильні відповіді
    4. виправити помилки
    5. здати вчителю

13. Записатися на курси
    1. знайти курси
    2. перевірити розклад
    3. заповнити заявку
    4. оплатити навчання
    5. почати заняття

14. Виконання домашнього завдання
    1. записати завдання
    2. прийти додому
    3. зібрати матеріали
    4. виконати вправи
...
15. Кар'єра викладача
    1. закінчити університет
    2. пройти педагогічну практику
    3. отримати роботу
    4. викладати предмет
    5. стати професором

## quiz: Освіта та навчання

> Оберіть правильну відповідь.

1. Хто викладає в університеті?
   - [ ] вчитель
   - [x] професор
   - [ ] директор
   - [ ] учень
   > В університеті викладають професори.

2. Що таке "аспірантура"?
   - [x] graduate school
   - [ ] high school
   - [ ] elementary school
   - [ ] kindergarten
...
3. Яка оцінка найвища в Україні?
   - [ ] 5
   - [ ] 10
   - [x] 12
   - [ ] 100
   > В Україні найвища оцінка — 12.

4. Що означає "здати іспит"?
   - [x] to pass an exam
   - [ ] to fail an exam
   - [ ] to take an exam
   - [ ] to skip an exam
   > "здати іспит" = to pass an exam

5. Хто такий "відмінник"?
   - [x] excellent student
   - [ ] bad student
   - [ ] teacher
   - [ ] principal
...
7. Коли в Україні починається навчальний рік?
   - [x] 1 вересня
   - [ ] 1 січня
   - [ ] 1 червня
   - [ ] 1 жовтня
...
9. Який документ після школи?
   - [ ] диплом
   - [x] атестат
   - [ ] сертифікат
   - [ ] паспорт
   > Після школи отримують атестат.

10. Що таке "контрольна робота"?
    - [x] test/quiz
    - [ ] homework
    - [ ] lecture
    - [ ] break
...
11. Хто керує школою?
    ...
    - [ ] декан
    - [ ] ректор
    > Школою керує директор.

12. Що означає "прогул"?
    - [x] skipping class
    - [ ] attending class
    - [ ] passing exam
    - [ ] studying
    > "прогул" = skipping class
...
14. Де зберігають книги в школі?
    - [ ] у класі
    - [x] у бібліотеці
    - [ ] у спортзалі
    - [ ] на подвір'ї
    > Книги зберігають у бібліотеці.

15. Що таке "сесія" в університеті?
    - [x] exam period
    - [ ] summer vacation
    - [ ] first day
    - [ ] graduation
...
## match-up: Предмет і що вивчають

> З'єднайте предмет з тим, що вивчають.

| Left | Right |
|------|-------|
| математика | числа і формули |
| історія | минулі події |
| біологія | живі організми |
| географія | країни і континенти |
| фізика | закони природи |
| хімія | речовини і реакції |
| література | книги і письменники |
| музика | мелодії і інструменти |
| інформатика | комп'ютери і програми |
| фізкультура | спорт і здоров'я |
| іноземна мова | інша мова |
| мистецтво | малювання і творчість |
| економіка | гроші і ринок |
| астрономія | зорі і планети |
| право | закони і правила |
