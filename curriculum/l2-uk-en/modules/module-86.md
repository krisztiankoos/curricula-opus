...
1. ___ (Заходь/Зайди), у мене тепло! (invitation)
   > [!answer] **Заходь**
2. ___ (Пиши/Напиши) мені листа до понеділка! (deadline)
   > [!answer] **Напиши**
...
2. Заходь!
   > [!answer] **Зайди** до мене завтра!
3. Бери!
   > [!answer] **Візьми** цю книгу!
4. Їж!
...
1. ___ (Не торкайся/Не торкнися) цього! (general prohibition)
   > [!answer] **Не торкайся**
2. Обережно, ___ (не падай/не впади)! (warning)
   > [!answer] **не впади**
3. ___ (Не забувай/Не забудь) зателефонувати! (warning)
   > [!answer] **Не забудь**
