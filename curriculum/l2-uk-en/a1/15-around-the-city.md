...
1. Іди ___, потім поверни направо. (straight)
   > [!answer] прямо
   > [!options] прямо | наліво | направо | назад

2. Аптека ___ банку, біля світлофора. (opposite)
   > [!answer] навпроти
   > [!options] навпроти | біля | за | перед

3. На перехресті поверніть ___. (to the left)
   > [!answer] наліво
   > [!options] наліво | направо | прямо | назад

4. Музей ___ парку. (near)
   > [!answer] біля
   > [!options] біля | навпроти | між | за

5. Це далеко? — Ні, ___. (close)
   > [!answer] близько
   > [!options] близько | далеко | поруч | туди

6. Станція метро ___ мостом. (behind)
   > [!answer] за
   > [!options] за | перед | навпроти | між

7. Я їду до університету ___. (by tram)
   > [!answer] на трамваї
   > [!options] на трамваї | на автобусі | на машині | пішки

8. Книгарня ___ кафе і банком. (between)
   > [!answer] між
   > [!options] між | біля | за | навпроти

9. Іди ___ вулиці Шевченка. (along)
   > [!answer] вздовж
   > [!options] вздовж | через | до | від

10. Театр ___ парку. (in front of)
    > [!answer] перед
    > [!options] перед | за | біля | навпроти

11. Поверніть ___ біля світлофора. (to the right)
    > [!answer] направо
    > [!options] направо | наліво | прямо | назад

12. Я ходжу на роботу ___. (on foot)
    > [!answer] пішки
    > [!options] пішки | на автобусі | метро | на машині

## fill-in: Transportation Phrases
> Complete the sentences with the correct transportation phrase.

1. Ми їдемо ___ до центру. (by bus)
   > [!answer] на автобусі
   > [!options] на автобусі | автобус | в автобусі | автобуса

2. Вона дістається на роботу ___. (by metro)
   > [!answer] метро
   > [!options] метро | на метро | в метро | метром

3. Я їжджу ___ щодня. (by bicycle)
   > [!answer] на велосипеді
   > [!options] на велосипеді | велосипед | велосипедом | у велосипеді

4. Вони приїхали ___. (by car)
   > [!answer] на машині
   > [!options] на машині | машина | машину | машиною

5. Ти їдеш ___? (by tram)
   > [!answer] на трамваї
   > [!options] на трамваї | трамвай | трамваєм | у трамваї

6. Я вже йду ___. (on foot)
   > [!answer] пішки
   > [!options] пішки | ногами | на ногах | пішком

7. Вони дістаються ___ до університету. (by taxi)
   > [!answer] на таксі
   > [!options] на таксі | таксі | таксієм | в таксі

8. Ми їдемо ___ на роботу. (by bus)
   > [!answer] на автобусі
   > [!options] на автобусі | автобусом | автобус | в автобусі

## true-false: City Navigation Facts
> Decide if each statement is true or false.

- [x] Only three Ukrainian cities have metro systems: Kyiv, Kharkiv, and Dnipro.
  > Correct! Kyiv (1960), Kharkiv (1975), Dnipro (1995).

- [ ] "Прямо" means "turn left."
  > Incorrect. "Прямо" means "straight" (forward).

- [x] In Kyiv metro, female announcers indicate trains heading toward the center.
  > Correct! Female voice = toward center, male voice = away from center.

- [ ] "Провулок" is a wide avenue.
  > Incorrect. Провулок is a narrow lane or alley, not a wide street.

- [x] Lviv is considered Ukraine's coffee capital.
  > Correct! The first coffeehouse in Eastern Europe opened in Lviv in 1574.

- [ ] "Навпроти" means "behind."
  > Incorrect. "Навпроти" means "opposite" or "across from." "За" means "behind."

- [x] "Пішки" means "on foot."
  > Correct! Пішки = walking.

- [ ] All Ukrainian cities use marshrutky.
  > Actually true! Marshrutky are ubiquitous across all Ukrainian cities, not just metro cities.

- [x] "Станція" can refer to both metro and train stations.
  > Correct! Станція is the general word for "station."

- [ ] "Близько" and "далеко" are opposites.
  > Correct! Близько = close/near, далеко = far.

- [x] S.T.A.L.K.E.R. is a Ukrainian game set in the Chornobyl Exclusion Zone.
  > Correct! Made by GSC Game World in Kyiv.
...
| Question | Answer |
|----------|--------|
| Де метро? | Прямо, біля банку. |
| Це далеко? | Ні, близько. П'ять хвилин пішки. |
| Як дістатися до центру? | На автобусі або на трамваї. |
| Де зупинка? | Навпроти парку. |
| Як ти їдеш на роботу? | Я їжджу метро. |
| Де вхід? | За мостом, наліво. |
| Перепрошую, де банк? | Біля світлофора, направо. |
| Скільки хвилин пішки? | Десь десять хвилин. |

## true-false: Transportation Facts
> Decide if each statement is true or false.
...
- [ ] You say "автобус" to mean "by bus."
  > Incorrect. You say "на автобусі" (on the bus).

- [x] "Метро" is used alone without a preposition.
  > Correct! "Я їду метро" (I go by metro).

- [ ] "На машині" means "by bicycle."
  > Incorrect. "На машині" = by car. By bicycle = "на велосипеді."

- [x] You use locative case (на + Loc) for most vehicles.
  > Correct! На автобусі, на трамваї, на велосипеді.

- [ ] "Трамвай" and "трамваї" are the same form.
  > Incorrect. "Трамвай" is nominative, "трамваї" is locative (used after "на").

- [x] "На таксі" is the correct way to say "by taxi."
  > Correct! Таксі is indeclinable, so use "на таксі."
