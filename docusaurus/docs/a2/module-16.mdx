...
Ти вже [___:6] відповідь? (Did you find?)`}
  blanks={[{ index: 0, answer: `прочитав`, options: [`прочитав`, `читав`] }, { index: 1, answer: `пише`, options: [`пише`, `написала`] }, { index: 2, answer: `зробили`, options: [`зробили`, `робили`] }, { index: 3, answer: `п'є`, options: [`п'є`, `випив`] }, { index: 4, answer: `готує`, options: [`готує`, `приготувала`] }, { index: 5, answer: `знайшов`, options: [`знайшов`, `знаходив`] }]}
/>
