...
<FillIn items={[
  {
    sentence: `Де [___] у метро? [Hint: Entrance]`,
    answer: `вхід`,
    options: [`вхід`, `вихід`, `похід`]
  },  {
    sentence: `Це небезпечний [___]. [Hint: Crossing]`,
    answer: `перехід`,
    options: [`перехід`, `захід`, `прихід`]
  },  {
    sentence: `Я не можу знайти [___]. [Hint: Exit]`,
    answer: `вихід`,
    options: [`вихід`, `вхід`, `схід`]
  },  {
    sentence: `Це зона для [___]. [Hint: Pedestrians (Gen pl)]`,
    answer: `пішоходів`,
    options: [`пішоходів`, `переходів`, `виходів`]
  },  {
    sentence: `Ми плануємо [___] в гори. [Hint: Hike]`,
    answer: `похід`,
    options: [`похід`, `вихід`, `захід`]
  },  {
    sentence: `[___] потяга о 10:00. [Hint: Arrival]`,
    answer: `Прихід`,
    options: [`Прихід`, `Відхід`, `Вихід`]
  },  {
    sentence: `Поїзд робить [___] зі станції. [Hint: Departure]`,
    answer: `відхід`,
    options: [`відхід`, `вхід`, `прихід`]
  },  {
    sentence: `Сонце сідає. Це [___]. [Hint: Sunset/West]`,
    answer: `захід`,
...
<Unjumble items={[
  { jumbled: `потрібен / Мені / підпис / ваш`, answer: `Мені потрібен ваш підпис.` },
  { jumbled: `зробив / Я / опис / товару`, answer: `Я зробив опис товару.` },
  { jumbled: `читає / Письменник / книгу / свою`, answer: `Письменник читає свою книгу.` },
  { jumbled: `гарний / У / вигляд / нього`, answer: `У нього гарний вигляд.` },
  { jumbled: `тут / Де / перехід`, answer: `Де тут перехід?` },
  { jumbled: `читання / Це / урок`, answer: `Це урок читання.` }
]} />
...
<Quiz questions={[
  {
    question: `If \"Вхід\" is Entrance, what is \"Вихід\"?`,
    options: [
    ...
    question: `What does \"Підпис\" literally mean?`,
    options: [
      { text: `Under-write`, correct: true },
      { text: `Over-write`, correct: false },
      { text: `Re-write`, correct: false }
    ]
  },  {
    question: `\"Передбачення\" (Prediction) contains which root?`,
    options: [
      { text: `БАЧ`, correct: true },
      { text: `ХІД`, correct: false },
      { text: `ПИС`, correct: false }
    ]
  },  {
    question: `A \"Пішохід\" goes on:`,
    options: [
      { text: `Foot (Пішки)`, correct: true },
      { text: `Car (Машина)`, correct: false },
      { text: `Horse (Кінь)`, correct: false }
    ]
  },  {
    question: `\"До побачення\" includes the root meaning:`,
    options: [
    ...
    question: `\"Погляд\" usually relates to:`,
    options: [
      { text: `Opinion / Glance`, correct: true },
      { text: `Walking style`, correct: false },
    ...
    options: [
      ...
      { text: `Письмо`, correct: false },
      { text: `Напис`, correct: false }
    ]
  },  {
    question: `\"Читання\" is the process of:`,
    options: [
...
<FillIn items={[
  {
    sentence: `Ваш [___] на документі. [Hint: Signature]`,
    answer: `підпис`,
    options: [`підпис`, `напис`, `запис`]
  },  {
    sentence: `Лікар робить [___] пацієнта. [Hint: Inspection/Review]`,
    answer: `огляд`,
    options: [`огляд`, `вигляд`, `погляд`]
  },  {
    sentence: `Це [___] симптомів. [Hint: Description]`,
    answer: `опис`,
    options: [`опис`, `напис`, `вхід`]
  },  {
    sentence: `У вас хворий [___]. [Hint: Look/Appearance]`,
    answer: `вигляд`,
    options: [`вигляд`, `огляд`, `перехід`]
  },  {
    sentence: `Зробіть [___] у карті. [Hint: Record/Entry]`,
    answer: `запис`,
    options: [`запис`, `напис`, `підпис`]
  },  {
    sentence: `Читати [___] на дверях. [Hint: Inscription/Sign]`,
    answer: `напис`,
    options: [`напис`, `опис`, `вихід`]
  },  {
    sentence: `Це точне [___]. [Hint: Prediction]`,
    answer: `передбачення`,
    options: [`передбачення`, `бачення`, `читання`]
  },  {
    sentence: `Ваше [___] майбутнього. [Hint: Vision]`,
    answer: `бачення`,
...
<Cloze
  passage={`Я йду на [___:1] [Hint: date].
...
Я скажу: \"До [___:8] [Hint: see you]!\"`}
  blanks={[{ answer: `побачення`, options: [`побачення`] }, { answer: `входу`, options: [`входу`] }, { answer: `вигляд`, options: [`вигляд`] }, { answer: `передбачення`, options: [`передбачення`] }, { answer: `похід`, options: [`похід`] }, { answer: `вигляд`, options: [`вигляд`] }, { answer: `вихід`, options: [`вихід`] }, { answer: `побачення`, options: [`побачення`] }]}
/>
...
<ErrorCorrection>
  <ErrorCorrectionItem
    sentence={`Де тут **випис**? (Intended: Exit)`}
    errorWord={`випис`}
    correctForm={`вихід`}
    options={[`вихід`, `випис`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Ваш **підхід** на документі. (Intended: Signature)`}
    errorWord={`підхід`}
    correctForm={`підпис`}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Це цікаве **читання**. (Intended: Date/Meeting)`}
    errorWord={`читання`}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Він **пішопис**. (Intended: Pedestrian)`}
    errorWord={`пішопис`}
    correctForm={`пішохід`}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Гарний **вхід**. (Intended: Look/Appearance)`}
    errorWord={`вхід`}
    correctForm={`вигляд`}
    options={[`вигляд`, `вхід`]}
  ...
  />
  <ErrorCorrectionItem
    sentence={`Зробити **захід** у зошит. (Intended: Note/Record)`}
    errorWord={`захід`}
    correctForm={`запис`}
    options={[`запис`, `захід`]}
...
<FillIn items={[
  {
    sentence: `[___]хід. [Hint: Entrance (In)]`,
    answer: `В`,
    options: [`В`, `Ви`, `Пере`]
  },  {
    sentence: `[___]хід. [Hint: Exit (Out)]`,
    answer: `Ви`,
    options: [`Ви`, `В`, `При`]
  },  {
    sentence: `[___]пис. [Hint: Signature (Under)]`,
    answer: `Під`,
    options: [`Під`, `На`, `За`]
  },  {
    sentence: `[___]пис. [Hint: Description (About/Round)]`,
    answer: `О`,
    options: [`О`, `В`, `Ви`]
  },  {
    sentence: `[___]хід. [Hint: Crossing (Across)]`,
    answer: `Пере`,
    options: [`Пере`, `За`, `При`]
  },  {
    sentence: `[___]хід. [Hint: Sunset/West (Behind)]`,
    answer: `За`,
    options: [`За`, `С`, `Ви`]
  },  {
    sentence: `[___]бачення. [Hint: Prediction (Fore)]`,
    answer: `Перед`,
    options: [`Перед`, `За`, `По`]
  },  {
    sentence: `[___]бачення. [Hint: Date (Po)]`,
    answer: `По`,
    options: [`По`, `За`, `На`]
  }
]} />
