...
3. ___ боку, це добре. (On one) → **З одного**
4. ___ сумніву, це найкращий варіант. (Without) → **Без**
5. Він помилився, ___ не мав досвіду. (because) → **тому що/бо**
6. ___, це хороша ідея. (In general) → **Загалом**

### Order from Certain to Uncertain

Rank these from most to least certain:

1. Я впевнений, що... → **1 (most certain)**
2. Мені здається, що... → **4**
3. Безперечно, ... → **2**
...
1. Він помилився. → **Мені здається, що він, можливо, помилився.**
2. Це погана ідея. → **На мою думку, це, мабуть, не найкраща ідея.**
3. Вона права. → **Здається, вона має рацію.**
