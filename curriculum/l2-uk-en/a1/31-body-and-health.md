...
> [!conversation] Викликати швидку (Calling an Ambulance)
>
...
## group-sort: Body Parts

> Sort body parts by area.
...
## group-sort: Болить vs Болять

> Sort by singular or plural verb.
...
## fill-in: Що болить? (What Hurts?)

> Choose the correct body part or verb.
...
11. У мене болить ___.
    > [!answer] ніс
    > [!options] ніс | очі | зуби | вуха

12. У мене болять ___.
    > [!answer] руки
    > [!options] руки | рука | живіт | горло

---

## fill-in: У лікаря (At the Doctor's)
...
11. Я здоровий, мені ___.
    > [!answer] добре
    > [!options] добре | погано | болить | хворий

12. У вас є ліки від ___?
    > [!answer] застуди
...
1. You feel sick. What do you say?
   - [x] Я хворий.
   - [ ] Я здоровий.
   - [ ] Я добре.
   - [ ] Дякую.

2. You have a headache. What do you say?
   - [x] У мене болить голова.
   - [ ] У мене болять голова.
   - [ ] Мені болить голова.
   - [ ] Я болить голова.

3. You need to find a pharmacy. What are you looking for?
   - [x] Аптека
   - [ ] Лікарня
   - [ ] Лікар
   - [ ] Швидка

4. You need to call emergency services in Ukraine. What number?
   - [x] 103
   - [ ] 911
   - [ ] 112
   - [ ] 999

5. You have a fever. What do you say?
   - [x] У мене температура.
   - [ ] У мене болить температура.
   - [ ] Мені температура.
   - [ ] Я температура.

6. Where do you go to buy medicine?
   - [x] В аптеку.
   - [ ] В лікарню.
   - [ ] До лікаря.
   - [ ] На швидку.

7. You have a cough. How do you say it?
   - [x] У мене кашель.
   - [ ] Мені кашель.
   - [ ] Я кашель.
   - [ ] У мене болить кашель.

8. What does "швидка допомога" mean?
   - [x] Ambulance
   - [ ] Pharmacy
   - [ ] Hospital
   - [ ] Doctor
...
- [x] "Болить" is used for singular body parts.
  > Correct! Use болить for one body part.

- [x] "Болять" is used for plural body parts.
  > Correct! Use болять for multiple body parts.

- [ ] "Аптека" means "hospital."
  > Incorrect! Аптека means "pharmacy." Hospital is "лікарня."

- [x] "Лікарня" means "hospital."
  > Correct!

- [ ] "Швидка допомога" means "pharmacy."
  > Incorrect! It means "ambulance" (literally "fast help").

- [x] "У мене температура" means "I have a fever."
  > Correct!

- [ ] "Головні болі" uses "болить."
  > Incorrect! It uses "болять" because болі is plural.

- [x] "Я хворий" means "I'm sick."
  > Correct!

- [x] In Ukraine, you call 103 for an ambulance.
  > Correct! 103 is the emergency number for medical help.

- [ ] "Хвора" is for men.
  > Incorrect! Хвора is feminine. Men use "хворий."

- [x] "Ліки" is always plural.
  > Correct! Ліки has no singular form.

- [x] "Зуб" is singular, "зуби" is plural.
  > Correct!
