...
<MatchUp pairs={[
  { left: `для`, right: `for (benefit)` },
  { left: `без`, right: `without` },
  { left: `через`, right: `because of` },
  { left: `про`, right: `about` },
  { left: `від`, right: `from (source)` },
  { left: `з`, right: `with` },
  { left: `після`, right: `after` },
  { left: `крім`, right: `except` }
]} />

### Case Requirements

<GroupSort groups={{
  "Genitive (Кого? Чого?)": ["для", "без", "від", "після", "крім", "замість"],
  "Accusative (Кого? Що?)": ["через", "про"],
  "Instrumental (Ким? Чим?)": ["з"],
  "Locative (На чому?)": ["о/об"]
}} />
...
<FillIn items={[
  {
    sentence: `Кава [___] цукру, будь ласка. [Hint: without]`,
    answer: `без`,
    options: [`без`, `для`, `з`]
  },  {
    sentence: `Це подарунок [___] тебе. [Hint: for you]`,
    answer: `для`,
    options: [`для`, `від`, `про`]
  },  {
    sentence: `Ми говорили [___] тебе. [Hint: about you]`,
    answer: `про`,
    options: [`про`, `через`, `для`]
  },  {
    sentence: `[___] дощ я залишився вдома. [Hint: because of]`,
    answer: `Через`,
    options: [`Через`, `Від`, `Про`]
  },  {
    sentence: `Лист [___] мами. [Hint: from mom]`,
    answer: `від`,
    options: [`від`, `для`, `про`]
  },  {
    sentence: `Кава [___] молоком. [Hint: with milk]`,
    answer: `з`,
    options: [`з`, `без`, `для`]
  },  {
    sentence: `Зустрінемось [___] третій. [Hint: at 3 o'clock]`,
    answer: `о`,
    options: [`о`, `після`, `для`]
  },  {
    sentence: `Всі прийшли, [___] Олега. [Hint: except]`,
    answer: `крім`,
...
<Quiz questions={[
  {
    question: `\"Для\" requires which case?`,
    options: [
    ...
    question: `\"Через дощ\" means:`,
    options: [
      { text: `Because of rain`, correct: true },
      { text: `Through the rain`, correct: false },
      { text: `About rain`, correct: false }
    ]
  },  {
    question: `\"Від мами\" means:`,
    options: [
      { text: `From mom`, correct: true },
      { text: `For mom`, correct: false },
      { text: `With mom`, correct: false }
    ]
  },  {
    question: `Which preposition means \"about\"?`,
    options: [
      { text: `про`, correct: true },
      { text: `для`, correct: false },
      { text: `від`, correct: false }
    ]
  },  {
    question: `\"Без цукру\" means:`,
    options: [
      { text: `Without sugar`, correct: true },
      { text: `With sugar`, correct: false },
      { text: `For sugar`, correct: false }
    ]
  },  {
    question: `\"О третій\" refers to:`,
    options: [
      { text: `Time (at 3 o'clock)`, correct: true },
      { text: `Place (at the third)`, correct: false },
      { text: `Person (about the third)`, correct: false }
    ]
  },  {
    question: `\"Замість чаю\" means:`,
    options: [
      { text: `Instead of tea`, correct: true },
      { text: `About tea`, correct: false },
      { text: `Without tea`, correct: false }
    ]
  },  {
    question: `Which preposition takes Instrumental?`,
    options: [
      { text: `з`, correct: true },
      { text: `для`, correct: false },
...
<Unjumble items={[
  { jumbled: `цукру | Кава | без`, answer: `Кава без цукру` },
  { jumbled: `тебе | Це | для`, answer: `Це для тебе` },
  { jumbled: `мами | Лист | від`, answer: `Лист від мами` },
  { jumbled: `дощ | залишився | Через | я | вдома`, answer: `Через дощ я залишився вдома` },
  { jumbled: `про | говорили | Ми | тебе`, answer: `Ми говорили про тебе` },
  { jumbled: `молоком | Кава | з`, answer: `Кава з молоком` },
  { jumbled: `третій | о | Зустрінемось`, answer: `Зустрінемось о третій` },
  { jumbled: `кави | Чай | замість`, answer: `Чай замість кави` }
]} />
...
<TrueFalse items={[
  {
    statement: `\"Для\" always takes the genitive case.`,
    isTrue: true,
    explanation: `Correct! Для + Gen: для мами, для тебе.`
  },  {
    statement: `\"Про\" takes the genitive case.`,
    isTrue: false,
    explanation: `False! \"Про\" takes accusative: про тебе, про книгу.`
  },  {
    statement: `\"Через\" can mean both \"because of\" and \"through.\"`,
    isTrue: true,
    explanation: `Yes! Через дощ (because of rain), через парк (through the park).`
  },  {
    statement: `\"Від\" is used for receiving something from a person.`,
    isTrue: true,
    explanation: `Correct! Лист від мами = a letter from mom.`
  },  {
    statement: `\"З\" always means \"from.\"`,
    isTrue: false,
    explanation: `False! \"З\" with instrumental means \"with\": з другом.`
  },  {
    statement: `\"Після\" means \"after\" and takes genitive.`,
    isTrue: true,
    explanation: `Yes! Після роботи = after work.`
  },  {
    statement: `\"Для\" and \"на\" mean the same thing.`,
    isTrue: false,
    explanation: `False! Для = benefit (для тебе), На = payment (на каву).`
  },  {
    statement: `\"Крім\" means \"except\" and takes genitive.`,
    isTrue: true,
    explanation: `Correct! Всі прийшли, крім Олега.`
  },  {
    statement: `\"О/об\" is used for clock time.`,
    isTrue: true,
    explanation: `Yes! О третій = at three o'clock.`
  },  {
    statement: `\"Через + noun\" and \"тому що + clause\" are interchangeable.`,
    isTrue: false,
    explanation: `They both mean \"because\" but have different grammar: через дощ vs тому що йде дощ.`
  },  {
    statement: `\"Замість\" means \"instead of.\"`,
    isTrue: true,
    explanation: `Correct! Чай замість кави = tea instead of coffee.`
  },  {
    statement: `\"Без\" expresses absence.`,
    isTrue: true,
    explanation: `Yes! Кава без цукру = coffee without sugar.`
  }
]} />
...
<Translate questions={[
  {
    ...
    options: [
      ...
      { text: `Подарунок від мами.`, correct: false },
      { text: `Подарунок про маму.`, correct: false },
      { text: `Кава без цукру.`, correct: true },
      { text: `Кава з цукром.`, correct: false },
      { text: `Кава для цукру.`, correct: false },
      { text: `Лист від друга.`, correct: true },
      { text: `Лист для друга.`, correct: false },
      { text: `Лист про друга.`, correct: false },
      { text: `Через дощ.`, correct: true },
      { text: `Про дощ.`, correct: false },
      { text: `Від дощу.`, correct: false },
      { text: `Ми говорили про тебе.`, correct: true },
      { text: `Ми говорили для тебе.`, correct: false },
      { text: `Ми говорили від тебе.`, correct: false },
      { text: `Кава з молоком.`, correct: true },
      { text: `Кава без молока.`, correct: false },
      { text: `Кава для молока.`, correct: false },
      { text: `Після роботи.`, correct: true },
      { text: `Для роботи.`, correct: false },
      { text: `Про роботу.`, correct: false },
      { text: `Всі прийшли, крім Олега.`, correct: true },
      { text: `Всі прийшли, для Олега.`, correct: false },
      { text: `Всі прийшли, від Олега.`, correct: false },
      { text: `О третій годині.`, correct: true },
      { text: `Для третьої години.`, correct: false },
      { text: `Після третьої години.`, correct: false },
      { text: `Чай замість кави.`, correct: true },
      { text: `Чай без кави.`, correct: false },
      { text: `Чай для кави.`, correct: false },
      { text: `Ліки від головного болю.`, correct: true },
      { text: `Ліки для головного болю.`, correct: false },
      { text: `Ліки про головний біль.`, correct: false },
      { text: `Я не можу без тебе.`, correct: true },
      { text: `Я не можу для тебе.`, correct: false },
      { text: `Я не можу від тебе.`, correct: false }
    ]
  }
]} />
...
<MatchUp pairs={[
  { left: `Гроші для тебе`, right: `Gift (benefit)` },
  { left: `Гроші на каву`, right: `Payment` },
  { left: `Через дощ`, right: `Cause (noun)` },
  { left: `Тому що йде дощ`, right: `Cause (clause)` },
  { left: `Від мами`, right: `From person` },
  { left: `З Києва`, right: `From place` },
  { left: `Каву з молоком`, right: `With (added)` },
  { left: `Каву без цукру`, right: `Without (removed)` }
]} />
...
Сироп [___:6] цукру підійде?`}
  blanks={[{ index: 0, answer: `від`, options: [`від`, `для`, `про`] }, { index: 1, answer: `Для`, options: [`Для`, `Від`, `Без`] }, { index: 2, answer: `для`, options: [`для`, `від`, `з`] }, { index: 3, answer: `Для`, options: [`Для`, `Від`, `Без`] }, { index: 4, answer: `від`, options: [`від`, `для`, `про`] }, { index: 5, answer: `без`, options: [`без`, `з`, `для`] }]}
/>

### Case Endings

<MatchUp pairs={[
  { left: `для мам__`, right: `для мами` },
  { left: `без цукр__`, right: `без цукру` },
  { left: `про книг__`, right: `про книгу` },
  { left: `через дощ__`, right: `через дощ` },
  { left: `з молок__`, right: `з молоком` },
  { left: `від друг__`, right: `від друга` },
  { left: `після робот__`, right: `після роботи` },
  { left: `о трет__`, right: `о третій` }
]} />
## 📚 Vocabulary
