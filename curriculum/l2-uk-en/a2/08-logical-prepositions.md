...
Марія отримала лист [___:1] мами.
...
> Match the correct usage.

- Гроші для тебе :: Gift (benefit)
- Гроші на каву :: Payment
- Через дощ :: Cause (noun)
- Тому що йде дощ :: Cause (clause)
- Від мами :: From person
- З Києва :: From place
- Каву з молоком :: With (added)
- Каву без цукру :: Without (removed)

## cloze: Pharmacy Dialogue

> Complete the dialogue.

Мені потрібні ліки [___:1] головного болю.
...
> Match the preposition phrase to correct ending.

- для мам__ :: для мами
- без цукр__ :: без цукру
- про книг__ :: про книгу
- через дощ__ :: через дощ
- з молок__ :: з молоком
- від друг__ :: від друга
- після робот__ :: після роботи
- о трет__ :: о третій
