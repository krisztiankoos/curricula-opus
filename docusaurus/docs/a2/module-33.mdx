...
Я пішов в [___:7], щоб купити таблетки.`}
  blanks={[{ index: 0, answer: `поліклініку`, options: [`поліклініку`, `школу`, `магазин`] }, { index: 1, answer: `турбує`, options: [`турбує`, `радіє`, `цікавить`] }, { index: 2, answer: `горло`, options: [`горло`, `стіл`, `вікно`] }, { index: 3, answer: `температуру`, options: [`температуру`, `книгу`, `сумку`] }, { index: 4, answer: `грип`, options: [`грип`, `спорт`, `відпочинок`] }, { index: 5, answer: `рецепт`, options: [`рецепт`, `квиток`, `паспорт`] }, { index: 6, answer: `аптеку`, options: [`аптеку`, `кіно`, `кафе`] }]}
/>
