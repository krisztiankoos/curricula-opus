...
<GroupSort groups={{
  "Animate Nouns": ["друг", "студент", "лікар", "водій", "колега", "офіціант", "гість", "сусід"],
  "Inanimate Nouns": ["стіл", "книга", "вікно", "машина", "телефон", "магазин"]
}} />
...
<Quiz questions={[
  {
    question: `Я бачу ___ у парку.`,
    options: [
      { text: `студент`, correct: false },
      { text: `студента`, correct: true },
      { text: `студенту`, correct: false },
      { text: `студенті`, correct: false }
    ]
  },  {
    question: `Вона знає мою ___.`,
    options: [
      { text: `подруга`, correct: false },
      { text: `подругу`, correct: true },
      { text: `подруги`, correct: false },
      { text: `подрузі`, correct: false }
    ]
  },  {
    question: `Ми чекаємо ___.`,
    options: [
      { text: `лікар`, correct: false },
      { text: `лікаря`, correct: true },
      { text: `лікару`, correct: false },
      { text: `лікарі`, correct: false }
    ]
  },  {
    question: `Ти знаєш цього ___?`,
    options: [
      { text: `чоловік`, correct: false },
      { text: `чоловіка`, correct: true },
      { text: `чоловіку`, correct: false },
      { text: `чоловікові`, correct: false }
    ]
  },  {
    question: `Вони бачать ___.`,
    options: [
      { text: `офіціант`, correct: false },
      { text: `офіціанта`, correct: true },
      { text: `офіціанту`, correct: false },
      { text: `офіціанті`, correct: false }
    ]
  },  {
    question: `Він любить свою ___.`,
    options: [
      { text: `вчителька`, correct: false },
      { text: `вчительку`, correct: true },
      { text: `вчительки`, correct: false },
      { text: `вчительці`, correct: false }
    ]
  },  {
    question: `Я шукаю ___.`,
    options: [
      { text: `водій`, correct: false },
      { text: `водія`, correct: true },
      { text: `водію`, correct: false },
      { text: `водієві`, correct: false }
    ]
  },  {
    question: `Вона бачить ___.`,
    options: [
      { text: `гість`, correct: false },
      { text: `гостя`, correct: true },
      { text: `гостю`, correct: false },
      { text: `гості`, correct: false }
    ]
  },  {
    question: `Ти чекаєш ___?`,
    options: [
      { text: `директор`, correct: false },
      { text: `директора`, correct: true },
      { text: `директору`, correct: false },
      { text: `директорі`, correct: false }
    ]
  },  {
    question: `Ми знаємо цю ___.`,
    options: [
      { text: `студентка`, correct: false },
      { text: `студентку`, correct: true },
      { text: `студентки`, correct: false },
      { text: `студентці`, correct: false }
    ]
  },  {
    question: `Він бачить нашого ___.`,
    options: [
      { text: `сусід`, correct: false },
      { text: `сусіда`, correct: true },
      { text: `сусіду`, correct: false },
      { text: `сусідові`, correct: false }
    ]
  },  {
    question: `Я люблю свого ___.`,
    options: [
      { text: `друг`, correct: false },
      { text: `друга`, correct: true },
      { text: `другу`, correct: false },
      { text: `другові`, correct: false }
    ]
  }
]} />
...
<FillIn items={[
  {
    sentence: `Я бачу ___ у магазині.`,
    answer: `колегу`,
...
<FillIn items={[
  {
    sentence: `У кав'ярні я бачу ___.`,
    answer: `офіціанта`,
    options: [`офіціант`, `офіціанта`, `офіціанту`, `офіціанті`]
  },  {
...
<Unjumble items={[
  { jumbled: `бачу / Я / студента / у / бібліотеці`, answer: `Я бачу студента у бібліотеці.` },
  { jumbled: `знає / Вона / мого / друга / добре`, answer: `Вона добре знає мого друга.` },
  { jumbled: `чекаємо / Ми / лікаря / у / лікарні`, answer: `Ми чекаємо лікаря у лікарні.` },
  { jumbled: `бачиш / Ти / офіціанта / там`, answer: `Ти бачиш офіціанта там?` },
  { jumbled: `любить / Він / свою / вчительку`, answer: `Він любить свою вчительку.` },
  { jumbled: `шукаю / Я / водія / нашого`, answer: `Я шукаю нашого водія.` },
  { jumbled: `знаємо / Ми / цього / директора`, answer: `Ми знаємо цього директора.` },
  { jumbled: `бачить / Вона / сусіда / кожного / ранку`, answer: `Вона бачить сусіда кожного ранку.` },
  { jumbled: `чекаєш / Ти / подругу / свою`, answer: `Ти чекаєш свою подругу?` },
  { jumbled: `люблю / Я / колегу / мого`, answer: `Я люблю мого колегу.` },
  { jumbled: `бачимо / Ми / пасажира / біля / метро`, answer: `Ми бачимо пасажира біля метро.` },
  { jumbled: `знає / Він / студентку / цю / з / школи`, answer: `Він знає цю студентку з школи.` }
]} />

### More Complex Sentences

<Unjumble items={[
  { jumbled: `бачу / Я / мого / друга / та / його / подругу`, answer: `Я бачу мого друга та його подругу.` },
  { jumbled: `чекаємо / Ми / нашого / вчителя / біля / університету`, answer: `Ми чекаємо нашого вчителя біля університету.` },
  { jumbled: `знає / Вона / всіх / студентів / у / групі`, answer: `Вона знає всіх студентів у групі.` },
  { jumbled: `бачиш / Ти / того / лікаря / там`, answer: `Ти бачиш того лікаря там?` },
  { jumbled: `любить / Він / свою / сусідку / дуже`, answer: `Він дуже любить свою сусідку.` },
  { jumbled: `шукаю / Я / нашого / директора / і / менеджера`, answer: `Я шукаю нашого директора і менеджера.` },
  { jumbled: `знаємо / Ми / цього / водія / добре`, answer: `Ми добре знаємо цього водія.` },
  { jumbled: `бачить / Вона / офіціанта / та / офіціантку`, answer: `Вона бачить офіціанта та офіціантку.` }
]} />
## 📚 Vocabulary
