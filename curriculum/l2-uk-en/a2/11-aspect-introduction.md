...
**Why aspect matters:** Choosing the wrong aspect is like saying "I was finishing the book yesterday" when you mean "I finished the book yesterday." Native speakers instantly notice incorrect aspect usage, so mastering this concept will dramatically improve your fluency.
...
In this module, you learned about verbal aspect — one of the most important features of Ukrainian grammar.

**Key Points:**
- Ukrainian verbs come in pairs: imperfective and perfective
- **Imperfective** = process, repetition, duration
- **Perfective** = completion, result, single events
- Most perfective verbs are formed by adding prefixes (про-, на-, з-, по-, ви-)
- Some pairs use different roots (говорити/сказати, брати/взяти)

**The Golden Rule:** Ask yourself — "Do I care about the process or the result?"
- Process → Imperfective
- Result → Perfective

Тепер ви розумієте основи аспекту! 📚
