...
Мама рада, що я [___:8]їхав.`}
  blanks={[{ index: 0, answer: `ви`, options: [`ви`, `при`, `від`] }, { index: 1, answer: `при`, options: [`при`, `ви`, `за`] }, { index: 2, answer: `за`, options: [`за`, `ви`, `при`] }, { index: 3, answer: `від`, options: [`від`, `при`, `ви`] }, { index: 4, answer: `при`, options: [`при`, `ви`, `від`] }, { index: 5, answer: `зу`, options: [`зу`, `при`, `ви`] }, { index: 6, answer: `їд`, options: [`їд`, `при`, `від`] }, { index: 7, answer: `при`, options: [`при`, `ви`, `від`] }]}
/>
