...
- посилання :: link
- мережа :: network
- зв'язок :: connection (signal)
- навушники :: headphones
- повідомлення :: message
- блогер :: blogger

## fill-in: Tech Sentences
...
2. Надішли мені ____ на це відео.
   > [!answer] посилання
   > [!options] посилання | мишку | клавіатуру | каву
   > Send me a link.

3. Він купив новий ____.
   > [!answer] ноутбук
   > [!options] ноутбук | ноутбука | ноутбуком | ноутбуки
   > Accusative inanimate: ноутбук.

4. Вона пише цікавий ____.
   > [!answer] блог
   > [!options] блог | блога | блогом | блогу
   > Accusative inanimate: блог.

5. Ми читаємо ____ в інтернеті.
   > [!answer] новини
   > [!options] новини | новина | новиною | новин
   > Accusative plural: новини.

6. У мене розбився ____ телефона.
   > [!answer] екран
   > [!options] екран | клавіатура | мишка | звук
   > Screen = екран.

7. Я ____ файл з інтернету.
   > [!answer] завантажую
   > [!options] завантажую | шукаю | пишу | сплю
   > I am downloading (завантажую).

8. Це мій улюблений ____.
   > [!answer] сайт
   > [!options] сайт | сайту | сайтом | сайти
   > Website/site matches 'улюблений' (masc).

9. Ти читав цю ____?
   > [!answer] статтю
   > [!options] статтю | стаття | статті | статтею
   > Accusative feminine: статтю.

10. Тут поганий ____.
    > [!answer] зв'язок
    > [!options] зв'язок | телефон | комп'ютер | стіл
    > Bad connection (зв'язок).
...
## true-false: Tech Facts

1. "Мишка" is an animal and a computer device.
   - [x] true
   > Yes, mouse (animal) and mouse (device) are both мишка.

2. "Новини" is a singular noun.
   - [x] false
   > Новини is plural (news). One piece of news = новина.

3. "Завантажувати" means to delete.
   - [x] false
   > It means to download/upload. Delete is видаляти.

4. Ukrainians use Telegram for news frequently.
   - [x] true
   > Telegram is a major news source.

5. "Скріншот" is used in Ukrainian.
   - [x] true
   > Yes, it's a loan word. Also знімок екрана.

6. Diia (Дія) is a paper document.
   - [x] false
   > Diia is a digital app for government services.

7. "Навушники" is always plural.
   - [x] true
   > Like "headphones" or "pants", it's plural only (pluralia tantum).

8. "Пароль" usually needs to be secret.
   - [x] true
   > Passwords should be secret.

9. First computer in continental Europe was built in Paris.
   - [x] false
   > It was built in Kyiv (MESM).

10. "Публікувати" means to read.
    - [x] false
    > To publish/post. To read is читати.

11. A "блогер" writes blogs or makes vlogs.
    - [x] true
    > Yes, blogger/vlogger.

12. Wifi is "вайфай" in Ukrainian.
    - [x] true
    > Phonetic borrowing: вайфай.

## group-sort: Hardware vs Software
...
## cloze: Digital Morning

Мій ранок починається зі [___:1]. Я вимикаю будильник на [___:2].
...
- Алло, підтримка? У мене не працює інтернет.
- Доброго дня. Який у вас логін?
- Мій логін — user123.
- Бачу ваш акаунт. Модем увімкнений?
- Так, всі лампочки горять.
- Спробуйте вимкнути його на 10 секунд.
- Хвилиночку... Вимкнув... Увімкнув.
- Тепер працює?
- О, так! Дякую. Ви мене врятували.
- Будь ласка. Маєте ще питання?
- Ні, це все. Гарного дня!
- До побачення!

## mark-the-words: Find the Gadgets
...
## select: Choose Best Word

1. I need to enter my...
   - [x] пароль
   - [ ] паспорт
   > Password.
