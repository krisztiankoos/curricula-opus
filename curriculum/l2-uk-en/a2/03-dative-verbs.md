...
> [!example] У кінотеатрі в Одесі (At the Cinema in Odesa)
...
> [!example] Родинна сцена в Харкові (Family Scene in Kharkiv)
...
**Success tip:** Before choosing an answer, identify whether the verb takes:
- Dative only (допомагати, вірити, дякувати)
- Dative + Accusative (давати, показувати, пояснювати)
- Dative + Infinitive (дозволяти, забороняти)

## match-up: Verb + Dative Pattern

- допомагати :: to help someone (Dat only)
- давати :: to give something to someone (Dat + Acc)
- заважати :: to bother someone (Dat only)
- показувати :: to show something to someone (Dat + Acc)
- подобатися :: to please someone (Dat only)
- пояснювати :: to explain something to someone (Dat + Acc)
- вірити :: to believe someone (Dat only)
- дякувати :: to thank someone (Dat only)
- радити :: to advise someone something (Dat + Acc)
- довіряти :: to trust someone (Dat only)
- забороняти :: to forbid someone (Dat + Inf)
- дозволяти :: to allow someone (Dat + Inf)

## fill-in: Choose the Correct Form

> Complete each sentence with the correct verb form.

1. Я ___ мамі готувати обід.
   > [!answer] допомагаю
   > [!options] допомагаю | допомагати | допомагає

2. Ця музика ___ мені спати.
   > [!answer] заважає
   > [!options] заважає | заважати | заважаю

3. Мені ___ цей фільм.
   > [!answer] подобається
   > [!options] подобається | подобаюсь | подобатися

4. Він ___ другові свою машину.
   > [!answer] показує
   > [!options] показує | показувати | показуюсь

5. Вчитель ___ учням нове правило.
   > [!answer] пояснює
   > [!options] пояснює | пояснювати | пояснюється

6. Я ___ тобі за допомогу!
   > [!answer] дякую
   > [!options] дякую | дякувати | дякуюсь

7. Ми не ___ цій людині.
   > [!answer] довіряємо
   > [!options] довіряємо | довіряти | довіряється

8. Батько ___ синові вчитися краще.
   > [!answer] радить
   > [!options] радить | радити | радиться

9. Лікар ___ пацієнтові курити.
   > [!answer] забороняє
   > [!options] забороняє | забороняти | забороняється

10. Я ___ тобі цю помилку.
    > [!answer] вибачаю
    > [!options] вибачаю | вибачати | вибачаюсь

11. Вона ___ подрузі новину.
    > [!answer] розповідає
    > [!options] розповідає | розповідати | розповідається

12. Мама ___ дітям гратися надворі.
    > [!answer] дозволяє
...
- [ ] "Допомагати" requires the accusative case.
  > Допомагати requires the dative: Я допомагаю мамі.

- [x] "Подобатися" makes the liked thing the grammatical subject.
  > Yes! "Мені подобається кава" — кава is the subject, мені is dative.

- [x] "Давати" requires both dative and accusative objects.
  > Correct! Я даю мамі книгу.

- [ ] "Вірити" can take an accusative object.
  > Вірити only takes dative: Я вірю другові.

- [x] "Забороняти" takes dative + infinitive.
  > Correct! Мама забороняє дітям гратися.

- [ ] "Заздрити" means "to help."
  > Заздрити means "to envy." Допомагати means "to help."

- [ ] In "Мені подобається музика," "мені" is the subject.
  > Мені is dative. Музика is the nominative subject.

- [x] "Дякую тобі" and "Дякую вам" both use the dative case.
  > Correct! Тобі and вам are both dative forms.

- [ ] "Показувати" is a dative-only verb.
  > Показувати takes Dat + Acc: Я показую другові фото.

- [x] "Співчувати" requires the dative case.
  > Correct! Я співчуваю родині.

- [ ] "Пояснювати" only needs an accusative object.
  > Пояснювати takes Dat + Acc: Я пояснюю учням правило.
...
3. Він показує друг свою машину.
   > [!error] друг
   > [!answer] другові
...
4. Вчитель пояснює учнів правило.
   > [!error] учнів
   > [!answer] учням
...
- Я раджу вам відпочивати і пити багато води.
- Мені боляче ковтати. Я думаю, це ангіна.
- Ви забороняєте мені працювати?
- Так, це ангіна. Я забороняю вам працювати цього тижня.

> [!answer]
> 1. Добрий день! Що вас турбує?
> 2. Мені боляче ковтати. Я думаю, це ангіна.
> 3. Так, це ангіна. Я забороняю вам працювати цього тижня.
> 4. Ви забороняєте мені працювати?
> 5. Я раджу вам відпочивати і пити багато води.
> 6. Дякую вам, лікарю!

---

- Так, звичайно!
- Ти можеш показати мені цю фотографію?
- Дякую! Мені дуже подобається це місце.
- Це Карпати. Я був там минулого року.
- Яке гарне місце! Що це?
- Тобі теж варто поїхати туди!

> [!answer]
> 1. Ти можеш показати мені цю фотографію?
> 2. Так, звичайно!
> 3. Яке гарне місце! Що це?
> 4. Це Карпати. Я був там минулого року.
> 5. Дякую! Мені дуже подобається це місце.
> 6. Тобі теж варто поїхати туди!

## mark-the-words: Find Dative Objects
...
- [ ] Я допомагаю брат.
- [x] Я допомагаю братові.
- [ ] Я допомагаю брата.

---

She shows her friend a photo.

- [x] Вона показує подрузі фото.
- [ ] Вона показує подруга фото.
- [ ] Вона показує подругу фото.

---

The doctor forbids the patient to smoke.

- [ ] Лікар забороняє пацієнт курити.
- [x] Лікар забороняє пацієнтові курити.
- [ ] Лікар забороняє пацієнта курити.
...
- [x] Я дякую тобі за допомогу.
- [ ] Я дякую ти за допомогу.

---

The music bothers the neighbors.

- [x] Музика заважає сусідам.
- [ ] Музика заважає сусіди.
- [ ] Музика заважає сусідів.

---

I like this film.

- [ ] Я подобаюся цей фільм.
- [x] Мені подобається цей фільм.
- [ ] Я подобаю цей фільм.
...
- [x] Вчитель пояснює учням правило.
- [ ] Вчитель пояснює учні правило.
...
Mom allows the children to play.

- [x] Мама дозволяє дітям гратися.
- [ ] Мама дозволяє діти гратися.
- [ ] Мама дозволяє дітей гратися.

---

She envies her friend.

- [ ] Вона заздрить подруга.
- [x] Вона заздрить подрузі.
- [ ] Вона заздрить подругу.
...
Grandma tells the grandchildren a story.

- [x] Бабуся розповідає онукам казку.
- [ ] Бабуся розповідає онуки казку.
- [ ] Бабуся розповідає онуків казку.
