...
1. читати → [___] [Hint: про-]
   > [!answer] прочитати
   > [!options] прочитати | читати | почитати

2. писати → [___] [Hint: на-]
   > [!answer] написати
...
8. готувати → [___] [Hint: при-]
   > [!answer] приготувати
   > [!options] приготувати | готувати | заготувати

## fill-in: Transform to Imperfective
...
1. "I finished reading the book" uses:
   - [x] Perfective
   - [ ] Imperfective

2. "I was reading when you called" uses:
   - [ ] Perfective
   - [x] Imperfective

3. "I read every day" uses:
   - [ ] Perfective
   - [x] Imperfective

4. "She wrote the letter (completed)" uses:
   - [x] Perfective
   - [ ] Imperfective

5. "We will do this tomorrow (once)" uses:
   - [x] Perfective
   - [ ] Imperfective

6. "I will be reading in the evening" uses:
   - [ ] Perfective
   - [x] Imperfective

7. "Did you finish?" expects:
   - [x] Perfective
   - [ ] Imperfective

8. "He studies every day" uses:
   - [ ] Perfective
   - [x] Imperfective
