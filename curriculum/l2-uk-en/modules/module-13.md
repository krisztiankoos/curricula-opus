...
1. кімната
   > [!answer] в кімнат__ (кімнаті)
2. стіл
   > [!answer] на стол__ (столі)
3. школа
   > [!answer] у школ__ (школі)
4. книга
   > [!answer] у книз__ (книзі) - г→з!
5. вулиця
   > [!answer] на вулиц__ (вулиці)

### Complete Sentences

1. Книга ___ столі. (на)
   > [!answer] на столі
2. Я ___ школі. (у)
   > [!answer] у школі
3. Вони ___ ресторані. (в)
   > [!answer] в ресторані
4. Кіт ___ кімнаті. (в)
   > [!answer] в кімнаті
...
1. Студент / університет
   > [!answer] Студент в університеті.
2. Кава / стіл
   > [!answer] Кава на столі.
3. Я / дім
   > [!answer] Я вдома. (or: Я в домі.)
4. Вони / робота
   > [!answer] Вони на роботі.
...
7. Why does "книга" become "книзі" in locative?
   - [ ] Because it's feminine
   - [ ] Because it ends in -а
   - [x] Because г changes to з before -і
   - [ ] It doesn't change
   > Consonant change: г → з before locative -і
