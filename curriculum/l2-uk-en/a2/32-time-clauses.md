...
- Щойно :: Just now/As soon as
- Доки :: While/Until
- Перш ніж :: Before (Literary)
- Тим часом як :: Meanwhile
- Кожного разу коли :: Every time when

## fill-in: Select the Connector

> Choose the best connector for the logic.

1. Я подзвоню, ___ приїду. (Sequence)
   > [!answer] коли
   > [!options] коли | поки | доки

2. Ми говорили, ___ їли піцу. (Simultaneous)
   > [!answer] поки
   > [!options] поки | як тільки | після того як

3. Я пішов спати ___ подивився фільм. (Sequence: after reading)
   > [!answer] після того як
   > [!options] після того як | перед тим як | поки

4. Мий руки ___ їсти. (Before)
   > [!answer] перед тим як
   > [!options] перед тим як | після того як | коли

5. ___ він зайшов, усі замовкли. (Instant)
   > [!answer] Як тільки
   > [!options] Як тільки | Поки | Перед тим як

6. Я чекав, ___ вона не прийшла. (Until)
   > [!answer] поки
   > [!options] поки | коли | як тільки

7. Ти читав, ___ я спав? (Simultaneous)
   > [!answer] в той час як
   > [!options] в той час як | як тільки | щойно

8. Вибачся ___ підеш. (Before)
   > [!answer] перш ніж
...
### Point (Sequencing/Instant)
- Коли я прийшов...
- Як тільки я побачив...
- Після того як я з'їв...
- Перед тим як вийти...
- Щойно я встав...
- Того дня, коли він народився...
...
- Доки я чекав...
- В той час як я спав...
- Тим часом як він говорив...
- Відколи ми дружимо...

## true-false: Connector Check

1. "Поки" means "After".
   - [ ] True
   - [x] False

2. "Перед тим як" needs a verb or clause.
   - [x] True
   - [ ] False

3. "Коли" can express simultaneous action too ("When I was walking...").
   - [x] True
   - [ ] False
   > Yes, aspect determines it.

4. "Як тільки" implies a delay.
   - [ ] True
   - [x] False
   > Speed/Immediacy.

5. "Після того як" is very clear about order.
   - [x] True
   - [ ] False

6. "Поки не" means "While not" or "Until".
   - [x] True
   - [ ] False

7. You never use commas with time clauses.
   - [ ] True
   - [x] False

8. "В той час як" is used for Parallel actions.
   - [x] True
   - [ ] False
...
[___:1] я був малим, я любив літо.
...
- Коли ти прийдеш?
- Я прийду, як тільки закінчу роботу.
- А коли ти закінчиш?
- Я закінчу, коли напишу звіт.
- Добре, подзвони мені перед тим як вийти.
- Гаразд. А що ти будеш робити, поки чекаєш?
- Я буду пити каву, поки ти працюєш.
- Ти як завжди!

> [!answer]
> 1. Коли ти прийдеш?
> 2. Я прийду, як тільки закінчу роботу.
> 3. А коли ти закінчиш?
> 4. Я закінчу, коли напишу звіт.
> 5. Добре, подзвони мені перед тим як вийти.
> 6. Гаразд. А що ти будеш робити, поки чекаєш?
> 7. Я буду пити каву, поки ти працюєш.
> 8. Ти як завжди!

## mark-the-words: Time Markers
...
1. While I sleep, you work.
   - [x] Поки я сплю, ти працюєш.
   - [ ] Коли я сплю, ти працюєш.

2. Before I ask...
   - [x] Перед тим як я запитаю...
   - [ ] Перед я запитаю...

3. After I finish...
   - [x] Після того як я закінчу...
   - [ ] Після закінчу...

4. As soon as I see him.
   - [x] Як тільки я побачу його.
   - [ ] Поки я побачу його.

5. Whenever I see him...
   - [x] Кожного разу, коли я бачу його...
   - [ ] Поки я бачу його...

6. Wait until I return.
   - [x] Чекай, поки я не повернуся.
   - [ ] Чекай, як я повернуся.
