...
COMMON_WORDS = {
    ...
    'це', 'то', 'той', 'та', 'те', 'ті', 'цей', 'ця',
    'і', 'й', 'та', 'або', 'чи', 'а', 'але', 'бо',
    'в', 'у', 'на', 'з', 'із', 'до', 'від', 'для', 'по', 'за', 'під', 'над', 'про', 'при',
    'є', 'був', 'була', 'було', 'були', 'буде', 'будуть',
    'так', 'ні', 'не', 'ще', 'вже', 'теж', 'також',
    'що', 'як', 'де', 'коли', 'чому', 'хто', 'який', 'яка', 'яке', 'які',
    'мій', 'моя', 'моє', 'мої', 'твій', 'його', 'її', 'наш', 'ваш', 'їх',
    'один', 'два', 'три', 'перший', 'другий',
    'дуже', 'тут', 'там', 'зараз', 'потім', 'завжди', 'ніколи',
}
