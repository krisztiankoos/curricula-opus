...
1. How do you pronounce **банк**?
   - [x] bank
   - [ ] bahk
   - [ ] vank
   - [ ] bahnk
   > The Н sounds like N, so банк = bank

2. How do you pronounce **радіо**?
   - [x] radio
   - [ ] padio
   - [ ] radyo
   - [ ] paдio
   > The Р sounds like R, so радіо = radio

3. How do you pronounce **кава**?
   - [x] kava (coffee)
   - [ ] kaba
   - [ ] cava
   - [ ] kaha
   > В sounds like V, not B

4. How do you pronounce **парк**?
   - [x] park
   - [ ] papk
   - [ ] pack
   - [ ] pank
...
5. How do you pronounce **суп**?
   - [x] soup
   - [ ] syp
   - [ ] sup (rhymes with cup)
   - [ ] soop
   > У sounds like OO in "moon"

6. How do you pronounce **футбол**?
   - [x] futbol (football)
   - [ ] футбол
   - [ ] footbol
   - [ ] futbol (rhymes with doll)
   > Ф = F, У = U, Т = T, Б = B, О = O, Л = L

7. What letter is **Р** equivalent to in English sound?
   - [x] R
   - [ ] P
   - [ ] N
   - [ ] B
   > Р is a False Friend, looks like P, sounds like R

8. What letter is **Н** equivalent to in English sound?
   - [x] N
   - [ ] H
   - [ ] M
   - [ ] X
   > Н is a False Friend, looks like H, sounds like N

9. What sound does **В** make?
   - [x] V as in "van"
   - [ ] B as in "ban"
   - [ ] W as in "wan"
   - [ ] F as in "fan"
   > В is a False Friend, looks like B, sounds like V

10. How do you pronounce **метро**?
    - [x] metro
    - [ ] metpo
    - [ ] мetpo
    - [ ] meyтро
    > All True Friends except Р (which is R)

11. Which word means "tourist"?
    - [x] турист
    - [ ] тупист
    - [ ] тунист
    - [ ] турісе
    > турист = tourist (Р is R sound)

12. Which word means "telephone"?
    - [x] телефон
    - [ ] телефоn
    - [ ] телефоп
    - [ ] тєлєфон
...
- [ ] The letter В sounds like "b" in "ball".
  > Incorrect! В is a False Friend. It sounds like "v" in "van".

- [x] The letter Н sounds like "n" in "no".
  > Correct! Despite looking like H, Н sounds like N.

- [ ] The letter Р sounds like "p" in "pet".
  > Incorrect! Р is a False Friend. It sounds like "r" in "red".

- [x] The letter С sounds like "s" in "sun".
  > Correct! Despite looking like C, С sounds like S.

- [ ] The letter У sounds like "y" in "yes".
  > Incorrect! У sounds like "oo" in "moon".
...
- [x] The letter К sounds like "k" in "kite".
  > Correct! К is a True Friend.

- [ ] The letter Х sounds like "x" in "box".
  > Incorrect! Х sounds like "ch" in Scottish "loch".

- [x] The letter Л sounds like "l" in "love".
  > Correct! Л is a New Letter that makes the L sound.

## fill-in: Complete the Word
