...
## fill-in: Instrumental for Means

> Choose the correct instrumental form for tools, transport, or means.

1. Я їду на роботу ___ (автобус) кожного ранку.
   > [!answer] автобусом
   > [!options] автобус | автобуса | автобусі | автобусом

2. Вона пише листа ___ (ручка) на столі.
   > [!answer] ручкою
   > [!options] ручка | ручки | ручці | ручкою

3. Він вільно говорить ___ (українська мова) з друзями.
   > [!answer] українською мовою
   > [!options] українська мова | українську мову | українській мові | українською мовою

4. Ми ріжемо хліб ___ (гострий ніж) на кухні.
   > [!answer] гострим ножем
   > [!options] гострий ніж | гострого ножа | гострому ножу | гострим ножем

5. Вони летять до Парижа ___ (літак) завтра вранці.
   > [!answer] літаком
   > [!options] літак | літака | літакові | літаком

6. Я їм суп ___ (велика ложка) кожного дня.
   > [!answer] великою ложкою
   > [!options] велика ложка | великої ложки | великій ложці | великою ложкою

7. Вона цікавиться ___ (історія) з дитинства.
   > [!answer] історією
   > [!options] історія | історії | історії | історією

8. Він малює картини ___ (олівець) і фарбами.
   > [!answer] олівцем
   > [!options] олівець | олівця | олівцю | олівцем

9. Студенти пишуть контрольну роботу ___ (синя ручка).
   > [!answer] синьою ручкою
   > [!options] синя ручка | синьої ручки | синій ручці | синьою ручкою

10. Як ти добираєшся до університету — ___ (метро)?
    > [!answer] метро
    > [!options] метро | метра | метрі | метром

## unjumble: Build the Sentence

> Arrange the words to form sentences with instrumental for means.

1. автобусом / Я / на роботу / їду / кожного ранку
   > [!answer] Я їду на роботу автобусом кожного ранку.
   > (I go to work by bus every morning.)

2. ручкою / Вона / листа / пише / на столі / синьою
   > [!answer] Вона пише листа синьою ручкою на столі.
   > (She writes a letter with a blue pen on the table.)

3. українською / Він / говорить / вільно / з друзями
   > [!answer] Він вільно говорить українською з друзями.
   > (He speaks Ukrainian fluently with friends.)

4. ножем / Ми / хліб / ріжемо / гострим / на кухні
   > [!answer] Ми ріжемо хліб гострим ножем на кухні.
   > (We cut bread with a sharp knife in the kitchen.)

5. літаком / Вони / летять / до Парижа / завтра
   > [!answer] Вони летять до Парижа літаком завтра.
   > (They fly to Paris by plane tomorrow.)

6. ложкою / Я / їм / суп / великою / щодня
   > [!answer] Я їм суп великою ложкою щодня.
   > (I eat soup with a big spoon every day.)

7. історією / Вона / цікавиться / українською / з дитинства
   > [!answer] Вона цікавиться українською історією з дитинства.
   > (She has been interested in Ukrainian history since childhood.)

8. олівцем / Він / малює / картини / і фарбами
   > [!answer] Він малює картини олівцем і фарбами.
   > (He draws pictures with pencil and paints.)

9. метро / Як / ти / добираєшся / до університету
   > [!answer] Як ти добираєшся до університету — метро?
   > (How do you get to university - by metro?)

10. велосипедом / Діти / їздять / до школи / кожного дня
    > [!answer] Діти їздять до школи велосипедом кожного дня.
    > (Children ride to school by bicycle every day.)
...
## select: Choose Transport or Tool
...
2. Which are writing/drawing tools?
   - [ ] тролейбус
   - [x] ручка
   - [ ] автобус
   - [x] олівець
...
4. Which verbs take instrumental for interests?
   - [x] цікавитися
   - [ ] писати
   - [x] захоплюватися
   - [x] займатися
...
6. Which are body parts used as instruments?
   - [x] рука
   - [ ] автобус
   - [x] нога
   - [ ] ручка
...
7. Which take instrumental without preposition for means?
   - [x] їхати автобусом
   - [ ] з другом
   - [x] писати ручкою
   - [ ] з батьками
...
8. Which are manner expressions with instrumental?
   - [x] говорити шепотом
   - [ ] їхати з другом
   - [x] йти швидким кроком
   - [ ] писати листа
   - [x] дивитися здивованими очима
   - [x] говорити тихим голосом
   - [ ] їхати автобусом
   - [ ] різати ножем
   - [ ] летіти літаком
   - [ ] малювати олівцем

9. Which are public transport vehicles?
   - [x] автобус
   - [x] тролейбус
   - [x] трамвай
   - [ ] велосипед
...
10. Which verbs require instrumental case?
    - [x] керувати
    - [x] володіти
    - [ ] читати
    - [x] цікавитися
...
2. говорить / Вона / українською / вільно
   > [!answer] Вона вільно говорить українською.
   > (She speaks Ukrainian fluently.)

3. ріжемо / ножем / Ми / хліб / гострим
   > [!answer] Ми ріжемо хліб гострим ножем.
   > (We cut bread with a sharp knife.)

4. літаком / Він / летить / Києва / до
   > [!answer] Він летить до Києва літаком.
   > (He flies to Kyiv by plane.)

5. цікавлюся / історією / Я / українською
   > [!answer] Я цікавлюся українською історією.
   > (I'm interested in Ukrainian history.)

6. поїздом / Вони / подорожують / Європою
   > [!answer] Вони подорожують Європою поїздом.
   > (They travel around Europe by train.)

7. ложкою / їм / Дитина / суп / великою
   > [!answer] Дитина їм суп великою ложкою.
   > (The child eats soup with a big spoon.)

8. олівцем / малює / Художник / картини / чорним
   > [!answer] Художник малює картини чорним олівцем.
   > (The artist draws pictures with a black pencil.)

9. метро / добираєшся / Як / університету / ти / до
   > [!answer] Як ти добираєшся до університету метро?
   > (How do you get to university by metro?)

10. німецькою / розмовляють / англійською / та / Студенти
    > [!answer] Студенти розмовляють англійською та німецькою.
    > (Students speak English and German.)
