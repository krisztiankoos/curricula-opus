...
|------|-----|---------|-----|--------|------|
| могти | /mɔɣˈtɪ/ | can, be able | verb | - | можу, можеш, може |
| мусити | /muˈsɪtɪ/ | must, have to | verb | - | мушу, мусиш, мусить |
| хотіти | /xɔˈtʲitɪ/ | want | verb | - | хочу, хочеш, хоче |
| повинен | /pɔˈvɪnɛn/ | should, must | adj | m | повинна (f), повинні (pl) |
| треба | /ˈtrɛbɑ/ | necessary, need to | adv | - | Мені треба йти |
| потрібно | /pɔˈtrʲibnɔ/ | needed, necessary | adv | - | Synonym of треба |
| можна | /ˈmɔʒnɑ/ | may, allowed | adv | - | Можна увійти? |
| не можна | /nɛ ˈmɔʒnɑ/ | forbidden, can't | adv | - | Тут не можна курити |
| вміти | /ˈvmʲitɪ/ | know how to | verb | - | вмію, вмієш, вміє |
| здатний | /ˈzdɑtnɪj/ | capable | adj | m | здатна (f), здатні (pl) |
| допомогти | /dɔpɔmɔɣˈtɪ/ | help (pf) | verb | - | Я можу допомогти |
| зрозуміти | /zrɔzuˈmʲitɪ/ | understand (pf) | verb | - | Я не міг зрозуміти |
| поспішати | /pɔspʲiˈʃɑtɪ/ | hurry | verb | - | Ми мусимо поспішати |
| працювати | /prɑt͡sʲuˈvɑtɪ/ | work | verb | - | Я мушу працювати |
| прийти | /prɪjˈtɪ/ | come (pf) | verb | - | Вона може прийти |
...
>
> Modal verbs express ability, necessity, and desire:
> - **Могти** (can): можу, можеш, може, можемо, можете, можуть
> - **Мусити** (must): мушу, мусиш, мусить + infinitive
> - **Хотіти** (want): хочу, хочеш, хоче + infinitive
> - **Повинен** (should): agrees with gender - повинен/повинна/повинні
> - **Треба/Потрібно** (need): impersonal - мені треба йти

> 🎯 **Coming Next**
>
> In Module 25, you'll learn daily routine vocabulary and how to describe your typical day using these modal verbs!