...
## quiz: Alphabet Knowledge
> Select the correct answer.

1. Which letter makes the "h" sound in Ukrainian?
   - [ ] Ґ
   - [x] Г
   - [ ] Х
   - [ ] К
   > Г (hook) makes the soft "h" sound.

2. What does the letter Ї sound like?
   - [ ] ya
   - [ ] ye
   - [x] yi
   - [ ] yu
   > Ї is the iotated "yi" sound, as in Київ (Kyiv).

3. Which letter makes the "shch" sound in борщ?
   - [ ] Ш
   - [ ] Ч
   - [x] Щ
   - [ ] Ц
   > Щ makes the distinctive "shch" blend.

4. What is special about the letter Ь?
   - [ ] It makes a "y" sound
   - [x] It softens the consonant before it
   - [ ] It makes an "e" sound
   - [ ] It's silent and has no effect
   > The soft sign Ь softens the preceding consonant.

5. Which letter makes the "ts" sound?
   - [ ] С
   - [ ] З
   - [x] Ц
   - [ ] Ч
   > Ц makes the sharp "ts" sound, as in центр.

6. What does Є sound like?
   - [x] ye
   - [ ] e
   - [ ] yi
   - [ ] ya
   > Є is the iotated "ye" sound, as in Європа.

7. How do you pronounce Київ in Ukrainian?
   - [ ] Keev
   - [ ] Kiev
   - [x] Kyiv
   - [ ] Kee-iv
   > Київ is pronounced Kyiv with the iotated Ї sound.

8. Which letter was lost in Russian but kept in Ukrainian?
   - [ ] Г
   - [x] Ґ
   - [ ] Щ
   - [ ] Є
   > Ґ (hard g) exists only in Ukrainian, not Russian.

9. What sound does Ж make?
   - [ ] sh
   - [x] zh
   - [ ] j
   - [ ] ch
   > Ж makes the "zh" sound like "s" in "pleasure."

10. In italic/cursive, which letter looks like Latin "m"?
    - [x] т
    - [ ] м
    - [ ] п
    - [ ] н
    > Italic т looks like "m" but still sounds like "t."

11. Which of these is a iotated vowel?
    - [ ] А
    - [ ] Е
    - [x] Ю
    - [ ] И
    > Ю is iotated (yu sound). А, Е, И are not iotated.

12. What does Я sound like?
    - [ ] ye
    - [x] ya
    - [ ] yi
    - [ ] y
    > Я makes the "ya" sound as in як (how).
...
## fill-in: Complete the Greetings
...
- [x] The letter Г makes an "h" sound, not a "g" sound.
  > Correct! Г is a soft breathy "h" sound.

- [x] Ґ exists in Ukrainian but was lost in Russian.
  > Correct! Ґ is unique to Ukrainian and a few other languages.

- [ ] The letter Ї sounds like "e" in English.
  > Incorrect! Ї sounds like "yi" (as in Kyiv).

- [x] Щ makes the "shch" sound in борщ.
  > Correct! Щ is the distinctive "shch" blend.

- [ ] The soft sign Ь makes a "y" sound.
  > Incorrect! Ь has no sound of its own; it softens the consonant before it.

- [x] There are four iotated vowels in Ukrainian: Є, Ї, Ю, Я.
  > Correct! These all have a built-in "y" sound.

- [ ] Київ should be pronounced "Keev" like in Russian.
  > Incorrect! In Ukrainian, it's Kyiv with the "yi" sound from Ї.

- [x] The Ukrainian alphabet has 33 letters total.
  > Correct! 33 letters including all the unique Ukrainian ones.

- [ ] Italic т looks like "t" in Latin script.
  > Incorrect! Italic т looks like "m" but still sounds like "t."

- [x] UNESCO recognized Ukrainian borscht culture as endangered heritage.
  > Correct! In 2022, due to the war.

- [x] Є sounds like "ye" as in "yes."
  > Correct! Є is the iotated "ye" sound.

- [ ] The letter И is the same as І in Ukrainian.
  > Incorrect! И is a hard "i" sound, while І is a soft "ee" sound.

## match-up: Ukrainian Cities
...
## group-sort: Print vs Italic Confusion
