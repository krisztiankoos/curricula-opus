---
module: 86
title: "Aspect in Imperatives"
subtitle: "Читай vs Прочитай!"
level: B1
phase: B1.1
duration: 45
...
1. ___ (Заходь/Зайди), у мене тепло! (invitation) → **Заходь**
2. ___ (Пиши/Напиши) мені листа до понеділка! (deadline) → **Напиши**
3. ___ (Не читай/Не прочитай) це! (general prohibition) → **Не читай**
4. ___ (Вставай/Встань), вже пізно! (urgent now) → **Встань**
5. ___ (Бери/Візьми) цю парасольку! (specific item) → **Візьми**
6. ___ (Не хвилюйся/Не захвилюйся)! (general advice) → **Не хвилюйся**
7. ___ (Їж/З'їж) усе! (finish everything) → **З'їж**
8. ___ (Дивись/Подивись) на це! (look at specific thing) → **Подивись**

### Transform: Invitation to Instruction

Change from imperfective (invitation) to perfective (instruction):

1. Сідай! → **Сядь** на це місце!
2. Заходь! → **Зайди** до мене завтра!
3. Бери! → **Візьми** цю книгу!
4. Їж! → **З'їж** це яблуко!
...
→ **Встань, умийся, поснідай і піди!**

*прийти, сісти, почекати*

→ **Прийди, сядь і почекай!**

### Negative Commands

Choose the correct aspect:

1. ___ (Не торкайся/Не торкнися) цього! (general prohibition) → **Не торкайся**
2. Обережно, ___ (не падай/не впади)! (warning) → **не впади**
3. ___ (Не забувай/Не забудь) зателефонувати! (warning) → **Не забудь**
4. ___ (Не кури/Не покури) тут! (general rule) → **Не кури**

## production

### Give Instructions

Create a sequence of commands for:
