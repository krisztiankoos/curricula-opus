...
Я пішов туди, [___:7] насолодитися атмосферою.`}
  blanks={[{ index: 0, answer: `Коли`, options: [`Коли`, `Що`] }, { index: 1, answer: `яке`, options: [`яке`, `який`] }, { index: 2, answer: `тому що`, options: [`тому що`, `хоча`] }, { index: 3, answer: `Але`, options: [`Але`, `Щоб`] }, { index: 4, answer: `де`, options: [`де`, `що`] }, { index: 5, answer: `що`, options: [`що`, `щоб`] }, { index: 6, answer: `щоб`, options: [`щоб`, `що`] }]}
/>
