---
title: "Verbal Aspect I"
subtitle: "Perfective & Imperfective"
phase: A2.2
duration: 45
transliteration: partial
tags: [verbs, aspect, perfective, imperfective, grammar]
objectives:
  - Understand the concept of verbal aspect
  - Distinguish perfective from imperfective verbs
  - Recognize common aspect pairs
  - Use aspect in basic contexts
grammar:
  - Verbal aspect introduction
  - Imperfective (process, repetition)
  - Perfective (completion, single action)
  - Common aspect pairs
---
...
### A New Dimension of Verbs

You've mastered tenses (past, present, future) and cases. Now meet **aspect** - a uniquely Slavic feature that English doesn't have!

**The big idea:**
- **Imperfective** = process, ongoing, repeated (like video)
- **Perfective** = completed, single, result (like photo)

Compare:
- Я **читав** книгу. (I was reading a book - process, imperfective)
- Я **прочитав** книгу. (I read/finished the book - completed, perfective)

Both are past tense, but different aspects!

> 💡 **Did You Know?**
>
> English lost verbal aspect centuries ago, but Slavic languages kept it. This is why Ukrainian has "verb pairs" - two verbs for every action! It might seem complex, but it allows incredible precision in describing actions.

## presentation

### What Is Aspect?

**Aspect** describes HOW an action happens, not WHEN:

| Aspect | Focus | Think of it as... |
|--------|-------|-------------------|
| Imperfective | Process, duration, repetition | Watching a movie |
| Perfective | Completion, result, single event | Taking a snapshot |

**Same action, different aspects:**
...
>
> Ask yourself:
> - Is the action **in progress** or **repeated**? → Imperfective
> - Is the action **completed** or a **single event**? → Perfective

### When to Use Imperfective

**1. Actions in progress:**
- Що ти **робиш**? - What are you doing? (right now)
- Я **читаю** книгу. - I'm reading a book. (in progress)
- Він **писав** листа. - He was writing a letter.

**2. Repeated/habitual actions:**
- Я **читаю** щодня. - I read every day.
- Вона **готувала** вечерю кожен день. - She cooked dinner every day.
- Ми **ходимо** в парк щонеділі. - We go to the park every Sunday.

**3. General statements:**
- Я **люблю** читати. - I love to read.
- Він добре **готує**. - He cooks well.
- Вона **говорить** українською. - She speaks Ukrainian.

**4. Duration markers:**
- Я **читав** дві години. - I was reading for two hours.
- Вона **працювала** весь день. - She was working all day.

> 📜 **History Bite: Slavic Aspect**
>
> Verbal aspect developed in Proto-Slavic over 1,500 years ago. While most Indo-European languages lost this feature, all Slavic languages (Ukrainian, Russian, Polish, Czech, etc.) preserved it. It's one of the defining characteristics of the Slavic language family!

### When to Use Perfective

**1. Completed actions (with result):**
...
**2. Single, specific events:**
- Я **купив** каву. - I bought (a) coffee. (one time)
- Він **сказав** "привіт." - He said "hello." (once)
- Вона **відкрила** вікно. - She opened the window. (one action)

**3. Sequential actions:**
- Я **прийшов** додому, **поїв** і **ліг** спати.
- I came home, ate, and went to bed. (sequence of completed actions)

**4. Future single actions:**
...
**Pattern 1: Prefix addition (most common)**

| Imperfective | Perfective | Prefix | Meaning |
|--------------|------------|--------|---------|
| читати | **про**читати | про- | to read |
| писати | **на**писати | на- | to write |
| робити | **з**робити | з- | to do |
| їсти | **з'**їсти | з'- | to eat |
| пити | **ви**пити | ви- | to drink |
| вчити | **ви**вчити | ви- | to learn |
| готувати | **при**готувати | при- | to prepare/cook |

**Pattern 2: Suffix change**

| Imperfective | Perfective | Change |
|--------------|------------|--------|
...
**Pattern 3: Different stems (irregular)**
...
> ⚡ **Pro Tip: Learning Pairs**
>
> Always learn verbs as pairs! When you learn "читати" (to read), immediately learn "прочитати" (to read/finish). Your vocabulary cards should show both forms.

### Aspect in Different Tenses

**Past tense - both aspects possible:**

| Imperfective | Perfective |
|--------------|------------|
| Я читав. (I was reading) | Я прочитав. (I read/finished) |
...
| Imperfective | Perfective |
|--------------|------------|
| Я читаю. (I'm reading) | ❌ (no present form) |
| Вона пише. (She's writing) | ❌ (no present form) |

Why? Because present means "in progress" - that's imperfective by nature!

**Future tense - both aspects, different forms:**

| Imperfective | Perfective |
|--------------|------------|
| Я буду читати. (I will be reading) | Я прочитаю. (I will read/finish) |
| Вона буде писати. (She will be writing) | Вона напише. (She will write/finish) |

Note: Imperfective future = буду + infinitive; Perfective future = conjugated form

### Aspect with Negation

**Imperfective negation - didn't do at all:**
- Я **не читав** цю книгу. - I didn't read this book. (never)
- Вона **не готувала** сьогодні. - She didn't cook today. (no cooking happened)

**Perfective negation - didn't complete:**
- Я **не прочитав** цю книгу. - I didn't finish this book. (started but didn't complete)
- Вона **не приготувала** вечерю. - She didn't manage to cook dinner. (intended but failed)

> 💡 **Key Insight**
>
> Negation + imperfective = action didn't happen
> Negation + perfective = action didn't reach completion
...
Yesterday (perfective for completed actions):
- Я **прокинувся** о сьомій.
- Я **приготував** сніданок і **поїв**.
- Я **прочитав** новини.
- Я **написав** три листи.

Generally (imperfective for habits):
...
**Situation 1: Reading**
- Я читав книгу. (I was reading - process)
- Я прочитав книгу. (I finished reading - result)

**Situation 2: Cooking**
- Вона готувала вечерю. (She was cooking - process)
- Вона приготувала вечерю. (She cooked/finished dinner - result)

**Situation 3: Writing**
- Він писав лист дві години. (He was writing for 2 hours - duration)
- Він написав лист за дві години. (He wrote the letter in 2 hours - completion)
...
1. спати / ліг / о десятій / Я / годині
   > [!answer] Я ліг спати о десятій годині.

2. о восьмій / прийшов / Я / годині / додому
   > [!answer] Я прийшов додому о восьмій годині.

3. за тридцять / приготував / вечерю / хвилин / Я
   > [!answer] Я приготував вечерю за тридцять хвилин.

4. холодильник / Я / і / продукти / взяв / відкрив
   > [!answer] Я відкрив холодильник і взяв продукти.

5. вечерю / з'їв / і / чай / випив / Я
   > [!answer] Я з'їв вечерю і випив чай.

6. перед сном / книгу / годину / Я / прочитав
   > [!answer] Я прочитав книгу годину перед сном.

7. душ / і / зуби / прийняв / почистив / Я
   > [!answer] Я прийняв душ і почистив зуби.

8. слів / десять / Я / нових / вивчив / українською
   > [!answer] Я вивчив десять нових слів українською.

9. другу / повідомлення / про / написав / Я / плани
   > [!answer] Я написав повідомлення другу про плани.

10. і / швидко / закрив / заснув / очі / Я
    > [!answer] Я закрив очі і заснув швидко.
...
| випити | /ˈvɪpɪtɪ/ | to drink (perf) | verb | - | pf of пити |
| вивчити | /ˈvɪvtʃɪtɪ/ | to learn (perf) | verb | - | pf of вчити |
| приготувати | /prɪɦotuˈvɑtɪ/ | to cook/prepare (perf) | verb | - | pf of готувати |
| купити | /kuˈpɪtɪ/ | to buy (perf) | verb | - | pf of купувати |
...
|--------|---------|---------|
| Imperfective | Process, duration, repetition | Я читав книгу. (was reading) |
| Perfective | Completion, result, single event | Я прочитав книгу. (finished) |

## Aspect in Tenses

| Tense | Imperfective | Perfective |
|-------|--------------|------------|
| Past | читав (was reading) | прочитав (read/finished) |
| Present | читаю (am reading) | ❌ (none) |
| Future | буду читати (will be reading) | прочитаю (will read/finish) |
...
> 💡 **Key Takeaways**
>
> - Aspect = HOW (process vs result), not WHEN
> - Imperfective: ongoing, repeated, duration
> - Perfective: completed, single, result
> - Learn verbs in pairs: читати/прочитати
> - Only imperfective has present tense
> - Context determines which aspect fits
